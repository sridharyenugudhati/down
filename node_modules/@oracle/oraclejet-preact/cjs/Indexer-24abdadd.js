...
var useSingleSelection = require('./useSingleSelection-90e7b44e.js');
...
var Collection = require('./Collection-44c673ef.js');
...
const ITEM_STYLE_CLASS = 'oj-indexer-item';
...
const SectionItem = compat.forwardRef((props, ref) => {
    ...
    const { classes } = hooks_UNSAFE_useComponentTheme.useComponentTheme(UNSAFE_Indexer_themes_redwood_IndexerTheme.IndexerRedwoodTheme, {
    ...
    const itemClasses = classNames.classNames([commonProps.class, classes]);
...
const OthersItem = compat.forwardRef((props, ref) => {
    ...
    const othersClasses = classNames.classNames([commonProps.class, classes]);
...
const SeparatorItem = compat.forwardRef((props, ref) => {
    ...
    const { classes, styles: { dotStyle } } = hooks_UNSAFE_useComponentTheme.useComponentTheme(UNSAFE_Indexer_themes_redwood_IndexerTheme.IndexerRedwoodTheme, {
        focused: commonProps.ref && commonProps.isFocusRingVisible ? 'isFocused' : 'notFocused'
    });
    const separatorClasses = classNames.classNames([commonProps.class, classes]);
 ...
 */
function Indexer({ sections = defaultSections, value, onCommit = () => { } }) {
    ...
    const { currentKeyProps } = hooks_PRIVATE_useCurrentKey.useCurrentKey((element) => utils_PRIVATE_collectionUtils.keyExtractor(element, ITEM_SELECTOR), true, utils_PRIVATE_collectionUtils.getPrevNextKey(rootRef.current, current, true, ITEM_SELECTOR), utils_PRIVATE_collectionUtils.getPrevNextKey(rootRef.current, current, false, ITEM_SELECTOR), undefined, undefined, current, (detail) => setCurrent(detail.value));
    ...
    const translations = hooks_UNSAFE_useTranslationBundle.useTranslationBundle('@oracle/oraclejet-preact');
    const { styles: { baseStyle, innerStyle } } = hooks_UNSAFE_useComponentTheme.useComponentTheme(UNSAFE_Indexer_themes_redwood_IndexerTheme.IndexerRedwoodTheme);
    return (jsxRuntime.jsxs("div", { ref: rootRef, class: baseStyle, children: [jsxRuntime.jsx(Flex.Flex, { align: "center", width: "6x", height: "100%", children: jsxRuntime.jsx("ul", { ...utils_UNSAFE_mergeProps.mergeProps(currentKeyProps, focusRingProps, selectionProps), ref: ulRef, tabIndex: 0, "aria-label": "Indexer", "aria-orientation": "vertical", "aria-valuemin": 0, "aria-describedby": uniqueId, role: "slider", class: innerStyle, children: jsxRuntime.jsx(Collection.Collection, { items: sections, children: itemRenderer }) }) }), jsxRuntime.jsx(HiddenAccessible.HiddenAccessible, { children: jsxRuntime.jsx("span", { id: uniqueId, children: getIndexerDescription(translations) }) })] }));
}
...
function getIndexerDescription(translations) {
    if (utils_PRIVATE_collectionUtils.isMobile()) {
...
//# sourceMappingURL=Indexer-24abdadd.js.map
