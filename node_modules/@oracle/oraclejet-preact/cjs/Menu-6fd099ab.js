...
var MenuItem = require('./MenuItem-a73f7852.js');
...
var Floating = require('./Floating-ac3c61ed.js');
var useModal = require('./useModal-63160742.js');
...
const MenuContainer = ({ children, 'aria-label': ariaLabel, currentFocus = 'menu', display, closeSubmenu, menuId, menuLevel }) => {
    ...
    */
    ...
    const initialFocusDone = hooks.useRef(false);
    ...
    const mouseLeaveFunction = (e) => {
        ...
        if (!e.relatedTarget.isEqualNode(menuContainerGeneralInformation.current.lastMouseLeaveMenuItemdRelatedTarget)) {
    ...
    hooks.useEffect(() => {
        if (menuLevel === 'main' && initialFocusDone.current)
            return;
    ...
    return (jsxRuntime.jsx("div", { ...(menuId && { id: menuId }), ref: menuContainerRef, tabIndex: !currentKey && (menuLevel === 'main' || display === 'sheet') ? 0 : -1, role: "menu", "aria-label": ariaLabel, class: classNames.classNames([
        ...
        ]), ...utils_UNSAFE_mergeProps.mergeProps(currentKeyProps, MenuItem.getKeyboardCloseProps(onClose, menuLevel), MenuItem.getCloseSubmenuEvent(direction, closeSubmenu), MenuItem.getMenuContainerFocusMethods(blurFunction, focusFunction), MenuItem.getMenuContainerMouseLeave(mouseLeaveFunction), MenuItem.getMenuPointerDown()), children: jsxRuntime.jsx(MenuItem.MenuContainerContext.Provider, { value: {
...
const DropdownMenu = compat.forwardRef(({ anchorRef, defaultPlacement, offsetValue, closeSubmenu, children, 'aria-label': ariaLabel, currentFocus, menuId, menuLevel, flipOptions }, ref) => {
    const { onClose } = MenuItem.useMenuContext();
    ...
    return (jsxRuntime.jsx(UNSAFE_Layer.Layer, { logicalParentRef: anchorRef, children: jsxRuntime.jsx(Floating.Floating, { class: UNSAFE_Menu_themes_DropdownMenuStyles_css.dropdownMenuStyles.base, onClickOutside: useOutsideClickHandler, anchorRef: anchorRef, flipOptions: flipOptions, shiftOptions: {
                mainAxis: false,
                crossAxis: false
            ...
            boundaryOptions: { padding: 0 }, placement: defaultPlacement, offsetValue: offsetValue, children: jsxRuntime.jsx("div", { style: {
                    minWidth: `${anchorRef.current && anchorRef.current.offsetWidth > MENU_MIN_WIDTH
                        ? anchorRef.current.offsetWidth
                        : MENU_MIN_WIDTH}px`
                }, ref: ref, children: jsxRuntime.jsx(MenuContainer, { menuLevel: menuLevel, closeSubmenu: closeSubmenu, "aria-label": ariaLabel, currentFocus: currentFocus, menuId: menuId, display: "dropdown", children: children }) }) }) }));
});
...
const SheetMenu = ({ children, 'aria-label': ariaLabel, currentFocus, anchorRef, closeSubmenu, menuLevel }) => {
    ...
    const { backdropRef } = useModal.useModal({ isOpen: true, onBackdropClick: dismissHandler });
    ...
    return (jsxRuntime.jsx(UNSAFE_Layer.Layer, { logicalParentRef: anchorRef, children: jsxRuntime.jsxs(ModalWrapper, { children: [jsxRuntime.jsx(ModalBackdrop, { backdropVisible: menuLevel === 'main' }), jsxRuntime.jsx(ModalContainer, { ref: backdropRef, children: jsxRuntime.jsx("div", { class: UNSAFE_Menu_themes_SheetMenuStyles_css.sheetMenuStyles.sheetMenuContainerWrapper, ...swipeProps, children: jsxRuntime.jsx(MenuContainer, { ...{ ariaLabel, currentFocus, display: 'sheet', closeSubmenu, menuLevel }, children: children }) }) })] }) }));
};
...
const Menu = ({ onClose, isOpen, initialFocus, ...menuProps }) => {
    //On close is consumed by the whole menu structure including the main menu and submenu ones.
    return (jsxRuntime.jsx(MenuItem.MenuContext.Provider, { value: { onClose, isMobile }, children: !isOpen ? null : (jsxRuntime.jsx(jsxRuntime.Fragment, { children: isMobile ? (jsxRuntime.jsx(SheetMenu, { ...{
                    ...menuProps,
...
//# sourceMappingURL=Menu-6fd099ab.js.map
