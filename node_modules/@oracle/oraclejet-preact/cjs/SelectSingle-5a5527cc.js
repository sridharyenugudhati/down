...
function useDisplayValue(itemText, valueItem) {
    ...
    const displayValue = hooks.useMemo(() => {
        return valueItem === undefined ? '' : PRIVATE_SelectCommon.renderItemText(valueItem, itemText) ?? '';
    }, [valueItem, itemText]);
    return displayValue;
}
...
//# sourceMappingURL=SelectSingle-5a5527cc.js.map
