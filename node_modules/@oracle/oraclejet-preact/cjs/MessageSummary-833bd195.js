 ...
 */
function MessageSummary({ text, variant = 'banner' }) {
    ...
    const classes = classNames.classNames([
        ...
        PRIVATE_Message_themes_MessageStyles_css.messageSummaryStyles.base,
        PRIVATE_Message_themes_MessageStyles_css.messageSummaryStyles[variant]
    ]);
    return (jsxRuntime.jsx("div", { role: "heading", class: classes, children: text }));
}

exports.MessageSummary = MessageSummary;
//# sourceMappingURL=MessageSummary-833bd195.js.map
