...
const useInteractionStyle = (isDisabled = false) => {
    ...
    const { activeProps, isActive } = hooks_UNSAFE_useActive.useActive();
    const { hoverProps, isHover } = hooks_UNSAFE_useHover.useHover({ isDisabled: !isHybrid });
    ...
    // merge all props
    const interactionProps = utils_UNSAFE_mergeProps.mergeProps(iosProps, activeProps, hoverProps);
