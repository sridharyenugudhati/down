...
const xUnits = (cnt) => cnt === 1
    ? fallbackVar(Common_themes_themeContract_css.scaleVars.size.units, 'var(--oj-core-spacing-1x)')
    : `calc(${cnt} * ${fallbackVar(Common_themes_themeContract_css.scaleVars.size.units, 'var(--oj-core-spacing-1x)')})`;
...
//# sourceMappingURL=utils-302a51a4.js.map
