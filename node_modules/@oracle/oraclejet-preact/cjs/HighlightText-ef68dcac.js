...
const highlightStyles = "_1stez3a";
/**
...
function highlighter(unhighlightedText, matchText) {
  if (matchText.length > 0 && unhighlightedText.length > 0) {
    ...
    const nodes = tokens.map((current, index) => index % 2 == 0 ? current : jsxRuntime.jsx("span", {
...
//# sourceMappingURL=HighlightText-ef68dcac.js.map
