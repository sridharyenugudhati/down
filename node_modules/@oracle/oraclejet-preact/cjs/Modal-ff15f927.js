...
const Modal = ({ children, isOpen, onBackdropClick, backdropVariant }) => {
    ...
    return isOpen ? (jsxRuntime.jsx(UNSAFE_Layer.Layer, { children: jsxRuntime.jsxs("div", { ref: modalRef, class: UNSAFE_Modal_themes_ModalStyles_css.baseStyle, children: [jsxRuntime.jsx(ModalBackdrop, { ref: backdropRef, variant: backdropVariant }), children] }) })) : null;
};

exports.Modal = Modal;
//# sourceMappingURL=Modal-ff15f927.js.map
