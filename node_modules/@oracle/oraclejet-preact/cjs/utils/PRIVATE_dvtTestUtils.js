...
const setupTabbableComponent = async (component, isTabbable) => {
    ...
    if (isTabbable !== undefined) {
        return preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, { environment: env, children: jsxRuntime.jsx(hooks_UNSAFE_useTabbableMode.TabbableModeContext.Provider, { value: { isTabbable: isTabbable }, children: component }) }));
    }
    else {
        return preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, { environment: env, children: component }));
    }
};
