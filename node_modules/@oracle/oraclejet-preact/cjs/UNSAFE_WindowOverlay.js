...
const WindowOverlay = ({ children, ...props }) => {
    ...
    const { styles, baseTheme: windowOverlayTheme } = hooks_UNSAFE_useComponentTheme.useComponentTheme(UNSAFE_WindowOverlay_themes_redwood_WindowOverlayTheme.WindowOverlayRedwoodTheme);
