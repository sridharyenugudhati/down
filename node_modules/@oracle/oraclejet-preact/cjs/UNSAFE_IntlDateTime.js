...
var UNSAFE_IntlFormatParse = require('./UNSAFE_IntlFormatParse.js');
var utils_UNSAFE_logger = require('./utils/UNSAFE_logger.js');
var _curry1$1 = require('./_curry1-0b6f3f91.js');
var _arity$2 = require('./_arity-f5624a57.js');
var _curry2$1 = require('./_curry2-a17eeaf0.js');
...
class NativeParserImpl {
    ...
    static _throwWeekdayMismatch(weekday, day) {
        ...
        const error = new UNSAFE_IntlFormatParse.FormatParseError(msg, errorInfo);
        throw error;
    }
...
const parseDateTime = (locale, formatter, resOptions, str) => {
    ...
    if (parsed) {
        if (result.warning) {
            utils_UNSAFE_logger.Logger.warn('The value ' + str + ' was leniently parsed to represent a date ' + parsed);
        }
    }
    return parsed;
};
...
const normalizeIsoString = (timeZone, value) => {
    if (value === undefined || value === null || value === '') {
        throw new UNSAFE_IntlFormatParse.FormatParseError('The format value cannot be empty.', {
    ...
    if (!exe) {
        const e = new UNSAFE_IntlFormatParse.FormatParseError('The format value must be a valid iso string.', {
