...
var listViewTestFixtures = require('./listViewTestFixtures-3cf90d1f.js');
var testHelpers = require('./testHelpers-9a7a5bb1.js');
...
const testAria = (TestComponent) => {
    ...
    it('aria structure and properties (multi-select)', async function () {
        ...
        const list = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, { environment: env, children: jsxRuntime.jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple" }) }));
        const grid = await testHelpers.getRoot(list);
        chai.expect(grid.getAttribute('aria-rowcount')).eq('10');
...
const testItemAction = (TestComponent) => {
    ...
    it('ItemAction - test press spacebar on item (Context value is embedded)', async () => {
        ...
        const list = preact.render(jsxRuntime.jsx(hooks_PRIVATE_useCollectionGestureContext.CollectionGestureContext.Provider, { value: 'embedded', children: jsxRuntime.jsx(TestComponent, { data: dataMetadata, onItemAction: onItemAction }) }));
        const grid = await testHelpers.getRoot(list);
        const items = await testHelpers.getItems(list, 'row');
        preact.fireEvent.click(items[0]);
        preact.fireEvent.keyDown(grid, { key: 'ArrowDown' });
    ...
    it('ItemAction - test press spacebar on item (Context value is default)', async () => {
        ...
        const list = preact.render(jsxRuntime.jsx(hooks_PRIVATE_useCollectionGestureContext.CollectionGestureContext.Provider, { value: 'default', children: jsxRuntime.jsx(TestComponent, { data: dataMetadata, onItemAction: onItemAction }) }));
        const grid = await testHelpers.getRoot(list);
        const items = await testHelpers.getItems(list, 'row');
        preact.fireEvent.click(items[0]);
        preact.fireEvent.keyDown(grid, { key: 'ArrowDown' });
...
const testSelection = (TestComponent) => {
    ...
    it('selects multiple items when clicking on Selector checkboxes', async () => {
        ...
        const list = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, { environment: env, children: jsxRuntime.jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple", selectedKeys: selected }) }));
        const items = await testHelpers.getContents(list);
        chai.expect(items[2].getAttribute('aria-selected')).eq('true');
    ...
    it('selects single items using enter keypress (Context value is embedded)', async () => {
        ...
        const list = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, { environment: env, children: jsxRuntime.jsx(hooks_PRIVATE_useCollectionGestureContext.CollectionGestureContext.Provider, { value: 'embedded', children: jsxRuntime.jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple" }) }) }));
        const items = await testHelpers.getContents(list);
    ...
    it('selects single items using enter keypress (Context value is default)', async () => {
        ...
        const list = preact.render(jsxRuntime.jsx(UNSAFE_Environment.RootEnvironmentProvider, { environment: env, children: jsxRuntime.jsx(hooks_PRIVATE_useCollectionGestureContext.CollectionGestureContext.Provider, { value: 'default', children: jsxRuntime.jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple" }) }) }));
        const items = await testHelpers.getContents(list);
        preact.fireEvent.keyUp(items[2], { key: 'Enter' });
        chai.expect(items[1].getAttribute('aria-selected')).eq('false');
        chai.expect(items[2].getAttribute('aria-selected')).eq('false');
...
//# sourceMappingURL=listViewSelectionTests-fcc3935a.js.map
