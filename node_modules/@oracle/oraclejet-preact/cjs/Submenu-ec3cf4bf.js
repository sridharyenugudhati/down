...
var PRIVATE_ThemedIcons_DirectionalExpandArrowIcon = require('./PRIVATE_ThemedIcons/DirectionalExpandArrowIcon.js');
var hooks_UNSAFE_useId = require('./hooks/UNSAFE_useId.js');
var MenuItem = require('./MenuItem-a73f7852.js');
var Menu = require('./Menu-6fd099ab.js');
var hooks = require('preact/hooks');
var PRIVATE_ThemedIcons_DirectionalCollapseArrowIcon = require('./PRIVATE_ThemedIcons/DirectionalCollapseArrowIcon.js');

const DropdownSubmenu = ({ label, children }) => {
    //Id of the submenu that will be used to connect via aria-owns, menuItem with its submenu
    const submenuId = hooks_UNSAFE_useId.useId();
    const preProcessedMenuItemID = hooks_UNSAFE_useId.useId();
    //MenuItem id
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(MenuItem.BaseMenuItem, { id: menuItemId, submenuId: submenuId, ref: submenuMenuItemRef, label: label, endIcon: jsxRuntime.jsx(PRIVATE_ThemedIcons_DirectionalExpandArrowIcon.DirectionalExpandArrowIcon, {}), type: "submenu", role: "menuitem", onAction: openSubmenuAction, hoverInfo: {
                ...
                openSubmenu: () => {
                    setIsOpen(true);
                    setCurrentFocus('firstItem');
                }, submenuRef: dropdownSubmenuRef, isSubmenuOpen: isOpen }), isOpen ? (jsxRuntime.jsx(Menu.DropdownMenu, { menuLevel: "sub", menuId: submenuId, 
...
const SheetSubmenu = ({ label, children }) => {
    const submenuId = hooks_UNSAFE_useId.useId();
    const submenuItemId = hooks_UNSAFE_useId.useId();
    const submenuTitleId = hooks_UNSAFE_useId.useId();
    ...
    return (jsxRuntime.jsxs(jsxRuntime.Fragment, { children: [jsxRuntime.jsx(MenuItem.BaseMenuItem, { id: submenuItemId, submenuId: submenuId, ref: submenuMenuItemRef, label: label, endIcon: jsxRuntime.jsx(PRIVATE_ThemedIcons_DirectionalExpandArrowIcon.DirectionalExpandArrowIcon, {}), type: "submenu", role: "menuitem", onAction: openSubmenuAction, openSubmenu: openSubmenuDirectional, isSubmenuOpen: isOpen }), !isOpen ? null : (jsxRuntime.jsxs(Menu.SheetMenu, { menuId: submenuId, closeSubmenu: closeDirectional, menuLevel: "sub", anchorRef: submenuMenuItemRef, 
                //TODO: We need to check if this initial focus is desired based on some W3C specs
                currentFocus: initialFocus, children: [jsxRuntime.jsx(MenuItem.BaseMenuItem, { id: submenuTitleId, menuItemLabelWeight: "bold", role: "menuitem", type: "submenu", startIcon: jsxRuntime.jsx(PRIVATE_ThemedIcons_DirectionalCollapseArrowIcon.DirectionalCollapseArrowIcon, {}), onAction: closeSubmenuPressingTitleItem, label: label }), children] }))] }));
};

/*Submenu behaves differently depending the device */
const Submenu = ({ label, children }) => {
    const { isMobile } = MenuItem.useMenuContext();
    return (jsxRuntime.jsx(jsxRuntime.Fragment, { children: isMobile ? (jsxRuntime.jsx(SheetSubmenu, { label: label, children: children })) : (jsxRuntime.jsx(DropdownSubmenu, { label: label, children: children })) }));
};

exports.Submenu = Submenu;
//# sourceMappingURL=Submenu-ec3cf4bf.js.map
