...
var PRIVATE_MessageLayer = require('./index-f1f6ebfb.js');
...
var MessagesManager = require('./MessagesManager-385a3962.js');
var MessageUtils = require('./MessageUtils-4d8c0ff6.js');
...
function MessageToast({ data, detailRendererKey, iconRendererKey, renderers, onClose, offset, position }) {
    ...
    const { UNSAFE_messagesLayerId } = hooks_UNSAFE_useMessagesContext.useMessagesContext();
    ...
    const { classes } = hooks_UNSAFE_useComponentTheme.useComponentTheme(UNSAFE_MessageToast_themes_redwood_MessageToastTheme.MessageToastRedwoodTheme);
    ...
    if (!shouldRender && data.length === 0) {
        return jsxRuntime.jsx(UNSAFE_LiveRegion.LiveRegion, { children: liveRegionText });
    }
    // TODO - Message Toast shouldn't always render as 'dark', it should be the inverse of the root environment context
    // See JET-57590
    return (jsxRuntime.jsxs(UNSAFE_Environment.EnvironmentProvider, { environment: { colorScheme: 'dark' }, children: [jsxRuntime.jsx(PRIVATE_MessageLayer.MessageLayer, { offset: paddedOffset, position: position, children: jsxRuntime.jsx("div", { class: classes, ref: containerDivRef, tabIndex: -1, id: UNSAFE_messagesLayerId, ...handlers, children: jsxRuntime.jsx(FocusTrap.FocusTrap, { autoFocusRef: autoFocusRef, isDisabled: !shouldTrapFocus, children: jsxRuntime.jsx(Flex.Flex, { direction: "column", gap: "1x", align: "center", maxWidth: maxWidth, children: jsxRuntime.jsx(MessagesManager.MessagesManager, { animationStates: animationStates, initialAnimationStyles: initialAnimationStyles, data: data, onMessageWillRemove: handleNextFocus, children: ({ index, item }) => (jsxRuntime.jsx(PRIVATE_Message.Message, { messageRef: setHTMLDivElement(item.key), item: item, detailRenderer: MessageUtils.getRendererWithoutIndex(item, detailRendererKey, renderers), iconRenderer: MessageUtils.getRendererWithoutIndex(item, iconRendererKey, renderers), index: index, onClose: onClose, translations: messageTranslations, variant: "toast" }, item.key)) }) }) }) }) }), jsxRuntime.jsx(UNSAFE_LiveRegion.LiveRegion, { children: liveRegionText })] }));
}

exports.MessageToast = MessageToast;
//# sourceMappingURL=MessageToast-1b4b33e4.js.map
