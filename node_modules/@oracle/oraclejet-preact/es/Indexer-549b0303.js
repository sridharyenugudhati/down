...
import { u as useSingleSelection } from './useSingleSelection-3c771c55.js';
...
import { keyExtractor, getPrevNextKey, isMobile } from './utils/PRIVATE_collectionUtils.js';
...
import { C as Collection } from './Collection-b858cf89.js';
...
const SectionItem = forwardRef((props, ref) => {
    ...
    const itemClasses = classNames([commonProps.class, classes]);
...
const OthersItem = forwardRef((props, ref) => {
    ...
    const othersClasses = classNames([commonProps.class, classes]);
...
const SeparatorItem = forwardRef((props, ref) => {
    ...
    const separatorClasses = classNames([commonProps.class, classes]);
...
//# sourceMappingURL=Indexer-549b0303.js.map
