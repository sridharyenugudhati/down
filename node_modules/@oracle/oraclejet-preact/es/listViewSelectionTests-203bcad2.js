...
import { R as RootEnvironmentProvider } from './index-ce660c32.js';
import { matchTranslationBundle } from './utils/UNSAFE_matchTranslationBundle.js';
import { CollectionGestureContext } from './hooks/PRIVATE_useCollectionGestureContext.js';
import { p as populateData } from './listViewTestFixtures-125a7706.js';
import { a as getItems, g as getRoot, b as getContents, m as mouseItemSelection, c as mouseCheckboxSelection } from './testHelpers-ab6caa30.js';
...
const testAria = (TestComponent) => {
    ...
    it('aria structure and properties (single-select)', async function () {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, selectionMode: "single" }));
        const grid = await getRoot(list);
        expect(grid.getAttribute('aria-rowcount')).eq('10');
    ...
    it('aria structure and properties (multi-select)', async function () {
        ...
        const list = render(jsx(RootEnvironmentProvider, { environment: env, children: jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple" }) }));
        const grid = await getRoot(list);
        expect(grid.getAttribute('aria-rowcount')).eq('10');
...
const testGridlines = (TestComponent) => {
    ...
    it('gridlines - bottom gridlines are visible', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, gridlines: visible }));
        const items = await getItems(list);
    ...
    it('gridlines - bottom gridlines are visible except for the last list item', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, gridlines: visibleExceptLast }));
        const items = await getItems(list);
        expect(isBottomGridlineVisible(items[0])).to.be.true;
        expect(isBottomGridlineVisible(items[1])).to.be.true;
    ...
    it('gridlines - bottom gridlines are visible; The top gridlines of the first list item is visible', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, gridlines: visibleWithFirst }));
        const items = await getItems(list);
    ...
    it('gridlines - bottom gridlines are visible except for the last list item. The top gridlines of the first list item is visible.', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, gridlines: visibleWithFirstButNotLast }));
        const items = await getItems(list);
        expect(isTopGridlineVisible(items[0])).to.be.true;
        expect(isBottomGridlineVisible(items[0])).to.be.true;
        expect(isBottomGridlineVisible(items[1])).to.be.true;
...
const testItemAction = (TestComponent) => {
    ...
    it('ItemAction - test click on item', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, onItemAction: onItemAction }));
    ...
    it('ItemAction - test press spacebar on item (Context value is embedded)', async () => {
        ...
        const list = render(jsx(CollectionGestureContext.Provider, { value: 'embedded', children: jsx(TestComponent, { data: dataMetadata, onItemAction: onItemAction }) }));
        const grid = await getRoot(list);
        const items = await getItems(list, 'row');
        fireEvent.click(items[0]);
        fireEvent.keyDown(grid, { key: 'ArrowDown' });
    ...
    it('ItemAction - test press spacebar on item (Context value is default)', async () => {
        ...
        const list = render(jsx(CollectionGestureContext.Provider, { value: 'default', children: jsx(TestComponent, { data: dataMetadata, onItemAction: onItemAction }) }));
        const grid = await getRoot(list);
        const items = await getItems(list, 'row');
        fireEvent.click(items[0]);
        fireEvent.keyDown(grid, { key: 'ArrowDown' });
    ...
    it('currentItemVariant - highlight', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, initialKey: dataMetadata[1].metadata.key, currentItemVariant: "highlight" }));
        const items = await getItems(list);
    ...
    it('currentItemVariant - none', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, initialKey: dataMetadata[1].metadata.key, currentItemVariant: "none" }));
        const items = await getItems(list);
        expect(isFocusHighlight(items[0])).to.be.false;
        fireEvent.click(items[0]);
        expect(isFocusHighlight(items[0])).to.be.false;
...
const testSelection = (TestComponent) => {
    it('select single - numeric key', async () => {
        ...
        const list = render(jsx(TestComponent, { data: dataMetadata, selectionMode: "single", onClick: () => {
    ...
    it('selects multiple items when clicking on Selector checkboxes', async () => {
        ...
        const list = render(jsx(RootEnvironmentProvider, { environment: env, children: jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple", selectedKeys: selected }) }));
        const items = await getContents(list);
        expect(items[2].getAttribute('aria-selected')).eq('true');
    ...
    it('selects single items using enter keypress (Context value is embedded)', async () => {
        ...
        const list = render(jsx(RootEnvironmentProvider, { environment: env, children: jsx(CollectionGestureContext.Provider, { value: 'embedded', children: jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple" }) }) }));
        const items = await getContents(list);
    ...
    it('selects single items using enter keypress (Context value is default)', async () => {
        ...
        const list = render(jsx(RootEnvironmentProvider, { environment: env, children: jsx(CollectionGestureContext.Provider, { value: 'default', children: jsx(TestComponent, { data: dataMetadata, selectionMode: "multiple" }) }) }));
        const items = await getContents(list);
        fireEvent.keyUp(items[2], { key: 'Enter' });
        expect(items[1].getAttribute('aria-selected')).eq('false');
        expect(items[2].getAttribute('aria-selected')).eq('false');
...
export { testAria as a, testKeys as b, testGridlines as c, testItemAction as d, testNavigation as e, testSelection as f, testRender as t };
//# sourceMappingURL=listViewSelectionTests-203bcad2.js.map
