...
import { x as xUnits, b as max } from '../../../utils-79fd9e1a.js';
...
const typography = {
    ...
    body: {
        ...
        sm: {
            fontSize: max(xUnits(3.4375), '12px'),
            lineHeight: '1.2',
            fontWeight: {
                regular: '400',
                semibold: '600',
