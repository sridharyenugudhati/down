...
import { DirectionalExpandArrowIcon } from './PRIVATE_ThemedIcons/DirectionalExpandArrowIcon.js';
import { useId } from './hooks/UNSAFE_useId.js';
import { m as useMenuContainerContext, B as BaseMenuItem, u as useMenuContext } from './MenuItem-9e739dca.js';
import { D as DropdownMenu, S as SheetMenu } from './Menu-827000ad.js';
import { useRef as useRef$1, useState as useState$1, useEffect as useEffect$1, useCallback as useCallback$1 } from 'preact/hooks';
import { DirectionalCollapseArrowIcon } from './PRIVATE_ThemedIcons/DirectionalCollapseArrowIcon.js';
...
const DropdownSubmenu = ({ label, children }) => {
    ...
    return (jsxs(Fragment, { children: [jsx(BaseMenuItem, { id: menuItemId, submenuId: submenuId, ref: submenuMenuItemRef, label: label, endIcon: jsx(DirectionalExpandArrowIcon, {}), type: "submenu", role: "menuitem", onAction: openSubmenuAction, hoverInfo: {
                ...
                openSubmenu: () => {
                    setIsOpen(true);
                    setCurrentFocus('firstItem');
                }, submenuRef: dropdownSubmenuRef, isSubmenuOpen: isOpen }), isOpen ? (jsx(DropdownMenu, { menuLevel: "sub", menuId: submenuId, 
...
const SheetSubmenu = ({ label, children }) => {
    ...
    return (jsxs(Fragment, { children: [jsx(BaseMenuItem, { id: submenuItemId, submenuId: submenuId, ref: submenuMenuItemRef, label: label, endIcon: jsx(DirectionalExpandArrowIcon, {}), type: "submenu", role: "menuitem", onAction: openSubmenuAction, openSubmenu: openSubmenuDirectional, isSubmenuOpen: isOpen }), !isOpen ? null : (jsxs(SheetMenu, { menuId: submenuId, closeSubmenu: closeDirectional, menuLevel: "sub", anchorRef: submenuMenuItemRef, 
...
const Submenu = ({ label, children }) => {
    ...
    return (jsx(Fragment, { children: isMobile ? (jsx(SheetSubmenu, { label: label, children: children })) : (jsx(DropdownSubmenu, { label: label, children: children })) }));
};

export { Submenu as S };
//# sourceMappingURL=Submenu-f04608eb.js.map
