...
import { SvgSymbol } from './UNSAFE_SvgShapes.js';
...
import './UNSAFE_SvgShapes/themes/SvgShapesStyles.css.js';
...
const BaseLegendItem = forwardRef(({ id, text, sectionIdx, itemIdx, isHighlighted, symbolHeight, symbolWidth, isFocused, isCurrent, isHidden, ...props }, ref) => {
    const textStyles = {
    ...
    const { legendItemBaseStyle, legendItemIsCurrent, legendItemOpacity, legendItemFocusRing } = styles;
...
const BaseLegend = ({ orientation = 'horizontal', highlightedIds, hiddenIds, focusedItemInfo, hoveredItemInfo, sectionIdx, activeId, isReadOnly, items, symbolHeight, symbolWidth, ...props }) => {
    ...
    return (jsx("div", { className: classNames([
            ...
            return (jsx(BaseLegendItem, { ref: isFocusedItem ? props.focusedItemRef : undefined, itemIdx: index, sectionIdx: sectionIdx, symbolHeight: symbolHeight, symbolWidth: symbolWidth, ...props, ...itemProps, gridRow: gridRow, gridCol: gridCol, minWidth: props.itemWidth, id: itemProps.isCurrent ? activeId : '', class: classNames([
...
function SectionalLegend({ orientation = 'horizontal', sectionTitleHAlign = 'start', sections, isReadOnly = true, onItemAction, onInput, ...props }) {
    ...
    const isHoriz = orientation === 'horizontal';
    return (jsxs("div", { ref: rootRef, tabIndex: isReadOnly ? undefined : 0, class: sectionalLegendBaseStyles, ...ariaProps, ...mergedProps, children: [jsx(Flex, { direction: isHoriz ? 'row' : 'column', wrap: 'wrap', gap: '2.3x', children: sections.map((section, index) => {
