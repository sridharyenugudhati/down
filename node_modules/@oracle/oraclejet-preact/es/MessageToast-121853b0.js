...
import { a as EnvironmentProvider } from './index-ce660c32.js';
...
import { M as MessageLayer } from './index-77f64294.js';
...
import { M as MessagesManager } from './MessagesManager-a46ef486.js';
import { a as getRendererWithoutIndex } from './MessageUtils-42e0fc95.js';
...
function MessageToast({ data, detailRendererKey, iconRendererKey, renderers, onClose, offset, position }) {
    ...
    // See JET-57590
    return (jsxs(EnvironmentProvider, { environment: { colorScheme: 'dark' }, children: [jsx(MessageLayer, { offset: paddedOffset, position: position, children: jsx("div", { class: classes, ref: containerDivRef, tabIndex: -1, id: UNSAFE_messagesLayerId, ...handlers, children: jsx(FocusTrap, { autoFocusRef: autoFocusRef, isDisabled: !shouldTrapFocus, children: jsx(Flex, { direction: "column", gap: "1x", align: "center", maxWidth: maxWidth, children: jsx(MessagesManager, { animationStates: animationStates, initialAnimationStyles: initialAnimationStyles, data: data, onMessageWillRemove: handleNextFocus, children: ({ index, item }) => (jsx(Message, { messageRef: setHTMLDivElement(item.key), item: item, detailRenderer: getRendererWithoutIndex(item, detailRendererKey, renderers), iconRenderer: getRendererWithoutIndex(item, iconRendererKey, renderers), index: index, onClose: onClose, translations: messageTranslations, variant: "toast" }, item.key)) }) }) }) }) }), jsx(LiveRegion, { children: liveRegionText })] }));
}

export { MessageToast as M };
//# sourceMappingURL=MessageToast-121853b0.js.map
