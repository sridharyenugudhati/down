...
import { u as useMenuContext, k as keyElemExtractor, g as getPrevNext, a as getNVisible, b as getLastVisible, c as getKeyboardCloseProps, d as getCloseSubmenuEvent, e as getMenuContainerFocusMethods, f as getMenuContainerMouseLeave, h as getMenuPointerDown, i as MenuContainerContext, j as getIsMobile, l as MenuContext } from './MenuItem-9e739dca.js';
...
import { F as Floating } from './Floating-44024b63.js';
import { u as useModal } from './useModal-d1a412ed.js';
...
const MenuContainer = ({ children, 'aria-label': ariaLabel, currentFocus = 'menu', display, closeSubmenu, menuId, menuLevel }) => {
    ...
    */
    ...
    return (jsx("div", { ...(menuId && { id: menuId }), ref: menuContainerRef, tabIndex: !currentKey && (menuLevel === 'main' || display === 'sheet') ? 0 : -1, role: "menu", "aria-label": ariaLabel, class: classNames([
        ...
        ]), ...mergeProps(currentKeyProps, getKeyboardCloseProps(onClose, menuLevel), getCloseSubmenuEvent(direction, closeSubmenu), getMenuContainerFocusMethods(blurFunction, focusFunction), getMenuContainerMouseLeave(mouseLeaveFunction), getMenuPointerDown()), children: jsx(MenuContainerContext.Provider, { value: {
...
const DropdownMenu = forwardRef(({ anchorRef, defaultPlacement, offsetValue, closeSubmenu, children, 'aria-label': ariaLabel, currentFocus, menuId, menuLevel, flipOptions }, ref) => {
    const { onClose } = useMenuContext();
    ...
    return (jsx(Layer, { logicalParentRef: anchorRef, children: jsx(Floating, { class: dropdownMenuStyles.base, onClickOutside: useOutsideClickHandler, anchorRef: anchorRef, flipOptions: flipOptions, shiftOptions: {
                mainAxis: false,
                crossAxis: false
            ...
            boundaryOptions: { padding: 0 }, placement: defaultPlacement, offsetValue: offsetValue, children: jsx("div", { style: {
                    minWidth: `${anchorRef.current && anchorRef.current.offsetWidth > MENU_MIN_WIDTH
                        ? anchorRef.current.offsetWidth
                        : MENU_MIN_WIDTH}px`
                }, ref: ref, children: jsx(MenuContainer, { menuLevel: menuLevel, closeSubmenu: closeSubmenu, "aria-label": ariaLabel, currentFocus: currentFocus, menuId: menuId, display: "dropdown", children: children }) }) }) }));
});
...
const SheetMenu = ({ children, 'aria-label': ariaLabel, currentFocus, anchorRef, closeSubmenu, menuLevel }) => {
    ...
    return (jsx(Layer, { logicalParentRef: anchorRef, children: jsxs(ModalWrapper, { children: [jsx(ModalBackdrop, { backdropVisible: menuLevel === 'main' }), jsx(ModalContainer, { ref: backdropRef, children: jsx("div", { class: sheetMenuStyles.sheetMenuContainerWrapper, ...swipeProps, children: jsx(MenuContainer, { ...{ ariaLabel, currentFocus, display: 'sheet', closeSubmenu, menuLevel }, children: children }) }) })] }) }));
};
...
const Menu = ({ onClose, isOpen, initialFocus, ...menuProps }) => {
    ...
    return (jsx(MenuContext.Provider, { value: { onClose, isMobile }, children: !isOpen ? null : (jsx(Fragment, { children: isMobile ? (jsx(SheetMenu, { ...{
                    ...menuProps,
...
//# sourceMappingURL=Menu-827000ad.js.map
