...
import { DropdownArrow, preventDefault, renderItemText, useSelectCommon, KEYS, isControlOrFunctionKey, isPhone, isBeforeDataFetch, DropdownUserAssistance, EmptyResults, DefaultList, isTablet, SelectMobileDropdown, DropdownList, Dropdown } from './PRIVATE_SelectCommon.js';
import './UNSAFE_Label.js';
import { TextField, ReadonlyTextField } from './UNSAFE_TextField.js';
import { InlineUserAssistance, CompactUserAssistance } from './UNSAFE_UserAssistance.js';
import { View } from './UNSAFE_View.js';
...
import './UNSAFE_Chip.js';
import { C as Chip } from './Chip-d10d029d.js';
import './UNSAFE_IconButton.js';
import './UNSAFE_Icon.js';
import { I as Icon } from './Icon-44f1fb0b.js';
import { I as IconButton } from './IconButton-080dd7b5.js';
import { F as Flex } from './Flex-1ec75561.js';
import { useRef, useId, useCallback, useEffect, useState, useImperativeHandle, useMemo } from 'preact/hooks';
import './hooks/UNSAFE_useFocusWithin.js';
import { useUser } from './hooks/UNSAFE_useUser.js';
import { isBackspaceOrDelete, isSelectAll } from './utils/PRIVATE_keyboardUtils.js';
...
import { CloseIcon as SvgClose } from './PRIVATE_ThemedIcons/CloseIcon.js';
import { TabbableModeContext, useTabbableMode } from './hooks/UNSAFE_useTabbableMode.js';
...
import { T as Text } from './Text-5d60dbd2.js';
...
import { u as useFocusWithin } from './useFocusWithin-d572dd3b.js';
import { LiveRegion } from './UNSAFE_LiveRegion.js';
import { T as TextFieldInput, i as isInputPlaceholderShown } from './TextFieldInput-65098632.js';
...
import { selectMultipleMobileFieldInputStyles } from './UNSAFE_SelectMultiple/themes/SelectMultipleMobileFieldInputStyles.css.js';
...
import { m as merge, a as isEmptyOrUndefined } from './stringUtils-0805904b.js';
import { e as equals } from './index-0a27685c.js';
import { mergeProps } from './utils/UNSAFE_mergeProps.js';
import { useEffectEvent } from './hooks/PRIVATE_useEffectEvent.js';
import { L as Label } from './Label-ee92eda1.js';
import { R as ReadonlyTextFieldInput } from './ReadonlyTextFieldInput-387bde77.js';
import './UNSAFE_HighlightText.js';
import './HighlightText-320e5c8e.js';
import './PRIVATE_List.js';
import './List-ce301f8f.js';
...
import './PRIVATE_ThemedIcons/DropdownArrowIcon.js';
...
import './InlineHelpSource-d3bbf3f1.js';
...
import './ComponentMessageContainer-5917bcb5.js';
...
import './CompactHelpSource-11fe262c.js';
...
import './utils/UNSAFE_interpolations/colors.js';
import './utils/UNSAFE_interpolations/padding.js';
import './utils/UNSAFE_interpolations/aria.js';
...
import './SelectMultipleMobileFieldInputStyles.styles.css';
...
function SelectMultipleField({ children, fieldLabel, hasInsideLabel, isBackButtonShown, isClearButtonShown, isDropdownArrowShown, isDropdownSelectedOnlyView, isSelectedValuesCountShown, selectedValuesCount, onBackButtonClick, onClearButtonClick, onDropdownArrowClick, onSelectedValuesCountKeyDown, onSelectedValuesCountKeyUp, onSelectedValuesCountMouseDown, onSelectedValuesCountToggle, ...passThroughTextFieldProps }) {
    ...
    const translations = useTranslationBundle('@oracle/oraclejet-preact');
    const backButton = (jsx(IconButton, { "aria-label": translations.selectMultiple_back(), variant: "borderless", onAction: onBackButtonClick, children: jsx(SvgNavLeft, {}) }));
    const clearButton = (jsx(IconButton, { "aria-label": translations.formControl_clear(), size: hasInsideLabel ? 'md' : 'sm', variant: "borderless", onAction: onClearButtonClick, children: jsx(SvgCancelS, {}) }));
    const dropdownArrow = (jsx(DropdownArrow, { isDisabled: isDisabled, size: hasInsideLabel ? 'md' : 'sm', onClick: onDropdownArrowClick }));
    ...
    return (jsx(TextField, { startContent: isBackButtonShown && backButton, mainContent: children, endContent: endContent, ...passThroughTextFieldProps }));
}
...
const styleInterpolations$1 = mergeInterpolations(supportedInterpolations);
/**
...
function SelectMultipleFieldInput({ displayValue, isTextTagListShown, isUserFiltering, liveRegionText, onExitNavigation, onRemove, removeIcon, selectedValuesDescriptionId, textTagListData, textTagListRef, userInput, virtualKeyboard, ...passThroughTextFieldInputProps }) {
    ...
    return (jsxs(Fragment, { children: [isTextTagListShown && (jsx(TextTagList, { "aria-label": translations.selectMultiple_selectedValues(), data: textTagListData, hasInsideLabel: passThroughTextFieldInputProps.hasInsideLabel, maxWidth: "50%", onExitNavigation: onExitNavigation, onRemove: onRemove, ref: textTagListRef, removeIcon: removeIcon })), jsx(Flex, { flex: 1, children: jsx(TextFieldInput, { "aria-autocomplete": "list", autoComplete: "off", 
            ...
            isTextTagListShown && (jsx(HiddenAccessible, { id: selectedValuesDescriptionId, 
                ...
                isHidden: true, children: displayValue })), jsx(LiveRegion, { children: liveRegionText })] }));
}
 ...
 */
const SelectMultipleMobileFieldInput = forwardRef(({ 'aria-controls': ariaControls, 'aria-describedby': ariaDescribedBy, 'aria-expanded': ariaExpanded, 'aria-invalid': ariaInvalid, 'aria-label': ariaLabel, 'aria-labelledby': ariaLabelledBy, displayValue, hasEmptyLabel, hasInsideLabel = false, isRequired, onBlur, onFocus, placeholder, textAlign, variant = 'default' }, ref) => {
    ...
    return (jsx("div", { "aria-autocomplete": "list", "aria-controls": ariaControls, "aria-describedby": ariaDescribedBy, "aria-expanded": ariaExpanded, "aria-invalid": ariaInvalid, "aria-label": ariaLabel, "aria-labelledby": mergedAriaLabelledBy, "aria-required": isRequired ? 'true' : undefined, class: rootDivStyleClasses, onBlur: onBlur, onFocus: onFocus, ref: ref, role: "combobox", ...(isTabbable && tabbableModeProps), children: jsx("div", { class: selectMultipleMobileFieldInputStyles.content, children: jsx(Text, { variant: displayValue ? 'inherit' : 'secondary', children: displayValue || myPlaceholder }) }) }));
});
...
function useSelectMultiple({ ariaDescribedBy, data: propData, inputRef, isDisabled, isFocused: propIsFocused, isReadonly, onCommit, onFilter, onLoadRange: propOnLoadRange, valueItems }) {
    ...
    const STABLE_onDataChange = useEffectEvent((newData) => {
...
const SelectMultiple = forwardRef(({ 'aria-describedby': propAriaDescribedBy, assistiveText, data: propData, helpSourceLink, helpSourceText, isDisabled: propIsDisabled, isLoading: propIsLoading, isReadonly: propIsReadonly, isRequired, isRequiredShown, itemRenderer, itemText, label, labelEdge: propLabelEdge, labelStartWidth: propLabelStartWidth, messages, onCommit, onFilter, onLoadRange: propOnLoadRange, placeholder, textAlign: propTextAlign, userAssistanceDensity: propUserAssistanceDensity, valueItems, variant = 'default', virtualKeyboard }, ref) => {
    ...
    const labelComp = (jsx(Label, { ...labelProps, ...(isPhone() ? { forId: undefined } : {}), children: label }));
    ...
    const dropdownInlineUserAssistance = isDropdownOpen &&
        ...
        (userAssistanceDensity === 'efficient' || userAssistanceDensity === 'reflow') ? (jsx(DropdownUserAssistance, { assistiveText: assistiveText, fieldLabel: label, helpSourceLink: helpSourceLink, helpSourceText: helpSourceText, userAssistanceDensity: userAssistanceDensity, ...(isPhone() ? mobileDropdownUserAssistanceProps : {}) })) : undefined;
    const isEmptyResults = isDataFetched && data?.totalSize === 0;
    const dropdownListContent = isEmptyResults ? (jsx(EmptyResults, {})) : (jsx(DefaultList, { ...(isPhone() ? mobileDropdownCollectionProps : collectionProps), "aria-label": label ?? '', currentItemVariant: "highlight", itemRenderer: itemRenderer, itemText: itemText, searchText: isDropdownSelectedOnlyView ? undefined : isUserFiltering ? searchText : undefined, selectionMode: "multiple" }));
