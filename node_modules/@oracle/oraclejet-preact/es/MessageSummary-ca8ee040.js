...
import { messageSummaryStyles } from './PRIVATE_Message/themes/MessageStyles.css.js';
...
function MessageSummary({ text, variant = 'banner' }) {
    ...
    return (jsx("div", { role: "heading", class: classes, children: text }));
}

export { MessageSummary as M };
//# sourceMappingURL=MessageSummary-ca8ee040.js.map
