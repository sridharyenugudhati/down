...
import './PRIVATE_ThemedIcons/CollapseUpIcon.js';
import { S as SvgChevronDown } from './index-06bc82a6.js';
import { S as SvgChevronUp } from './index-88afee8f.js';
...
const CollapsibleContent = ({ children, id, isExpanded, onTransitionEnd }) => {
    ...
    return (jsx("div", { className: styles.contentChildrenStyle, ref: nodeRef, id: id, tabIndex: -1, style: contentInitialStyle.current, "aria-hidden": !isExpanded || undefined, children: state !== 'unmounted' && children }));
};
/**
...
const Collapsible = ({ header, children, isDisabled = false, isExpanded = false, iconPosition = 'start', variant = 'basic', onToggle, onTransitionEnd, 'aria-label': accessibleLabel, 'aria-labelledby': accessibleLabelId }) => {
    ...
    return (jsxs(Fragment$1, { children: [jsx(CollapsibleHeader, { id: headerId, contentId: contentId, toggleHandler: toggleHandler, isDisabled: isDisabled, isExpanded: isExpanded, iconPosition: iconPosition, variant: variant, accessibleLabel: accessibleLabel, accessibleLabelId: accessibleLabelId, children: header }), jsx(CollapsibleContent, { id: contentId, isExpanded: isExpanded, onTransitionEnd: transitionEndHandler, children: children })] }));
};

export { Collapsible as C };
//# sourceMappingURL=Collapsible-f5b25858.js.map
