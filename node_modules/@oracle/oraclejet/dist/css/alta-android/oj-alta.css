...
.oj-theme-json {
  font-family: '{"name":"alta","targetPlatform":"android","behavior":"alta","jetReleaseVersion":"v15.1.5"}'; }
...
.oj-button-menu-icon-only-dropdown-icon:before, .oj-inputdatetime-calendar-icon:before, .oj-inputdatetime-time-only .oj-inputdatetime-time-icon:before, .oj-combobox-open-icon:before, .oj-searchselect-open-icon:before, .oj-select-open-icon:before {
  content: "\f10b"; }
...
.oj-fwk-icon-arrowtail-n:before, .oj-table-column-header-asc-icon:before,
...
.oj-fwk-icon-arrowtail-s:before, .oj-table-column-header-dsc-icon:before, .oj-datagrid-sort-descending-icon:before {
  content: "\f118"; }

.oj-fwk-icon-arrowtail-w:before, html:not([dir="rtl"]) .oj-fwk-icon-arrowtail-start:before, html:not([dir="rtl"]) .oj-fwk-icon-back:before, html:not([dir="rtl"]) .oj-hybrid-applayout-header-icon-back:before, html:not([dir="rtl"]) .oj-navigationlist-previous-icon:before, html[dir="rtl"] .oj-fwk-icon-arrowtail-end:before, html[dir="rtl"] .oj-fwk-icon-next:before, html[dir="rtl"] .oj-navigationlist-slider .oj-navigationlist-collapse-icon:before, .oj-navigationlist-slider html[dir="rtl"] .oj-navigationlist-collapse-icon:before {
  content: "\f119"; }
...
.oj-fwk-icon-caret02-n:before, .oj-pagingcontrol-nav-previous-vertical-icon:before, .oj-inputnumber-up-icon:before {
  content: "\f121"; }

.oj-fwk-icon-caret02-s:before, .oj-pagingcontrol-nav-next-vertical-icon:before, .oj-inputnumber-down-icon:before {
  content: "\f122"; }
...
.oj-fwk-icon-dots-vertical:before, .oj-navigationlist-overflow-item-icon:before, .oj-tabbar-overflow-item-icon:before, .oj-select-multiple-open-icon:before {
  content: "\f132"; }
...
.oj-fwk-icon-checkbox-tristate-selected, .oj-selector .oj-selector-wrapper.oj-selected, .oj-selector:hover .oj-selector-wrapper.oj-selected {
  background-image: url("images/sprites/sprite.svg");
  background-size: 1386px 52px;
...
@media print, (max-resolution: 0.99dppx) {
  .oj-fwk-icon-checkbox-tristate-selected, .oj-selector .oj-selector-wrapper.oj-selected, .oj-selector:hover .oj-selector-wrapper.oj-selected {
    background-image: none; }
  .oj-fwk-icon-checkbox-tristate-selected:before, .oj-selector .oj-selector-wrapper.oj-selected:before, .oj-selector:hover .oj-selector-wrapper.oj-selected:before {
    content: url("images/checkbox_tristate_selected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-checkbox-tristate-unselected, .oj-selector .oj-selector-wrapper:not(.oj-selected), .oj-selector:hover .oj-selector-wrapper:not(.oj-selected) {
  background-image: url("images/sprites/sprite.svg");
  background-size: 1386px 52px;
...
@media print, (max-resolution: 0.99dppx) {
  .oj-fwk-icon-checkbox-tristate-unselected, .oj-selector .oj-selector-wrapper:not(.oj-selected), .oj-selector:hover .oj-selector-wrapper:not(.oj-selected) {
    background-image: none; }
  .oj-fwk-icon-checkbox-tristate-unselected:before, .oj-selector .oj-selector-wrapper:not(.oj-selected):before, .oj-selector:hover .oj-selector-wrapper:not(.oj-selected):before {
    content: url("images/checkbox_tristate_unselected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-menuitemcheckbox-dis-selected, .oj-menucheckbox-icon.oj-selected.oj-disabled::after {
  background-image: url("images/sprites/sprite.svg");
  background-size: 1386px 52px;
...
.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-dis-selected, .oj-hicontrast .oj-menucheckbox-icon.oj-selected.oj-disabled::after {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-dis-selected:before {
  content: url("images/menuitemcheckbox_dis_selected.svg");
  width: 100%;
  height: 100%; }
...
.oj-fwk-icon-menuitemcheckbox-dis-unselected, .oj-menucheckbox-icon.oj-disabled::after {
  background-image: url("images/sprites/sprite.svg");
  background-size: 1386px 52px;
...
.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-dis-unselected, .oj-hicontrast .oj-menucheckbox-icon.oj-disabled::after {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-dis-unselected:before {
  content: url("images/menuitemcheckbox_dis_unselected.svg");
  width: 100%;
  height: 100%; }
...
.oj-fwk-icon-menuitemcheckbox-ena-selected, .oj-menucheckbox-icon.oj-selected::after {
  background-image: url("images/sprites/sprite.svg");
  background-size: 1386px 52px;
...
.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-ena-selected, .oj-hicontrast .oj-menucheckbox-icon.oj-selected::after {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-ena-selected:before {
  content: url("images/menuitemcheckbox_ena_selected.svg");
  width: 100%;
  height: 100%; }
...
.oj-fwk-icon-menuitemcheckbox-ena-unselected, .oj-menucheckbox-icon::after {
  background-image: url("images/sprites/sprite.svg");
  background-size: 1386px 52px;
...
.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-ena-unselected, .oj-hicontrast .oj-menucheckbox-icon::after {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-menuitemcheckbox-ena-unselected:before {
  content: url("images/menuitemcheckbox_ena_unselected.svg");
  width: 100%;
  height: 100%; }
...
.oj-fwk-icon-spinner-50, .oj-pulltorefresh-icon-50-percent {
  background-image: url("images/sprites/sprite.svg");
  background-size: 1386px 52px;
  background-position: -1168px -2px;
  width: 40px;
  height: 40px; }
...
html:not([dir="rtl"]) .oj-menu-item-icon {
  margin-left: calc(-24px - 1.125rem);
  margin-right: 1.125rem; }

html[dir="rtl"] .oj-menu-item-icon {
  margin-right: calc(-24px - 1.125rem);
...
html:not([dir="rtl"]) .oj-message-category, html:not([dir="rtl"])
.oj-message-header .oj-message-summary {
  padding: 0px 0px 0px 10px; }

html[dir="rtl"] .oj-message-category, html[dir="rtl"]
.oj-message-header .oj-message-summary {
  padding: 0px 10px 0px 0px; }

.oj-message-timestamp:before {
  content: "\25CF";
  padding: 0px 4px; }
...
.oj-progress-circle-overlay {
  ...
  background-image: url("images/spinner_full_default.gif"); }
...
.oj-form-layout-option-defaults {
  font-family: '{"labelEdge":"top","colspanWrap":"nowrap","direction":"column","columnGap":"2rem"}'; }
