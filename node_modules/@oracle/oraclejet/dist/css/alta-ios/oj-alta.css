...
.oj-theme-json {
  font-family: '{"name":"alta","targetPlatform":"ios","behavior":"alta","jetReleaseVersion":"v15.1.5"}'; }
...
:root {
  ...
  --oj-private-button-global-chroming-default: half;
  ...
  --oj-private-popup-global-modality-default: modal;
  ...
  --oj-private-menu-global-sheet-cancel-affordance: "menuItem";
  --oj-private-menu-global-sheet-swipe-down-behavior: "none";
  --oj-private-menu-global-drop-down-modality: "modal";
  --oj-private-menu-global-sheet-modality: "modal";
  --oj-private-menu-global-sheet-margin-bottom: 12px;
  --oj-private-input-number-button-global-chroming-default: outlined;
...
.oj-button-menu-icon-only-dropdown-icon:before, .oj-combobox-open-icon:before, .oj-searchselect-open-icon:before, .oj-select-open-icon:before {
  content: "\f10b"; }
...
.oj-fwk-icon-arrow03-e:before, html[dir="rtl"] .oj-fwk-icon-arrow03-start:before, html:not([dir="rtl"]) .oj-fwk-icon-arrow03-end:before, html:not([dir="rtl"]) .oj-collapsible-close-icon:before, html:not([dir="rtl"]) .oj-menu-submenu-icon:before, html:not([dir="rtl"]) .oj-collapsed > .oj-treeview-item-content > .oj-treeview-disclosure-icon:before, html:not([dir="rtl"]) .oj-rowexpander-expand-icon:before, html:not([dir="rtl"]) .oj-collapsed > .oj-tree-disclosure-icon:before, html:not([dir="rtl"]) .oj-tree-drop-ptr:before {
  content: "\f10d"; }
...
.oj-fwk-icon-arrow03-s:before, .oj-collapsible-open-icon:before, .oj-rowexpander-collapse-icon:before {
  content: "\f111"; }

.oj-fwk-icon-arrow03-se:before, html[dir="rtl"] .oj-fwk-icon-arrow03-s-start:before, html:not([dir="rtl"]) .oj-fwk-icon-arrow03-s-end:before, html:not([dir="rtl"]) .oj-expanded > .oj-treeview-item-content > .oj-treeview-disclosure-icon:before, html:not([dir="rtl"]) .oj-expanded > .oj-tree-disclosure-icon:before {
  content: "\f112"; }

.oj-fwk-icon-arrow03-sw:before, html:not([dir="rtl"]) .oj-fwk-icon-arrow03-s-start:before, html[dir="rtl"] .oj-fwk-icon-arrow03-s-end:before, html[dir="rtl"] .oj-expanded > .oj-treeview-item-content > .oj-treeview-disclosure-icon:before, html[dir="rtl"] .oj-expanded > .oj-tree-disclosure-icon:before {
  content: "\f113"; }

.oj-fwk-icon-arrow03-w:before, html:not([dir="rtl"]) .oj-fwk-icon-arrow03-start:before, html[dir="rtl"] .oj-fwk-icon-arrow03-end:before, html[dir="rtl"] .oj-collapsible-close-icon:before, html[dir="rtl"] .oj-menu-submenu-icon:before, html[dir="rtl"] .oj-collapsed > .oj-treeview-item-content > .oj-treeview-disclosure-icon:before, html[dir="rtl"] .oj-rowexpander-expand-icon:before, html[dir="rtl"] .oj-collapsed > .oj-tree-disclosure-icon:before, html[dir="rtl"] .oj-tree-drop-ptr:before {
  content: "\f114"; }
...
.oj-fwk-icon-caret02-n:before, .oj-pagingcontrol-nav-previous-vertical-icon:before, .oj-table-column-header-asc-icon:before,
...
.oj-fwk-icon-caret02-s:before, .oj-pagingcontrol-nav-next-vertical-icon:before, .oj-table-column-header-dsc-icon:before, .oj-datagrid-sort-descending-icon:before {
  content: "\f120"; }
...
.oj-fwk-icon-caret03-e:before, html[dir="rtl"] .oj-fwk-icon-caret03-start:before, html:not([dir="rtl"]) .oj-fwk-icon-caret03-end:before, html:not([dir="rtl"]) .oj-menu-submenu-icon:before, html:not([dir="rtl"]) .oj-listview-drill-icon:before {
  content: "\f126"; }
...
.oj-fwk-icon-cbsingle-dis-selected, .oj-choice-direction-row .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon,
...
.oj-hicontrast .oj-fwk-icon-cbsingle-dis-selected, .oj-hicontrast .oj-choice-direction-row .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-item.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-row.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-item.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-row.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-item.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-row.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-dis-selected:before, .oj-hicontrast .oj-choice-direction-row .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-item.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-row.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-item.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-row.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-item.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-row.oj-disabled.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before {
...
@media print, (max-resolution: 0.99dppx) {
  ...
  .oj-checkboxset-single .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-cbsingle-dis-selected:before, .oj-choice-direction-row .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-direction-row .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-item.oj-disabled.oj-selected .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-row.oj-disabled.oj-selected .oj-radiocheckbox-icon:before {
    content: url("images/cbsingle_dis_selected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-cbsingle-dis-unselected, .oj-choice-direction-row .oj-choice-item.oj-disabled .oj-radiocheckbox-icon,
...
.oj-hicontrast .oj-fwk-icon-cbsingle-dis-unselected, .oj-hicontrast .oj-choice-direction-row .oj-choice-item.oj-disabled .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-item.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row.oj-disabled .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-row.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item.oj-disabled .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-item.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row.oj-disabled .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-row.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item.oj-disabled .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-item.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row.oj-disabled .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-row.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-dis-unselected:before, .oj-hicontrast .oj-choice-direction-row .oj-choice-item.oj-disabled .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-item.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row.oj-disabled .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-row.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item.oj-disabled .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-item.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row.oj-disabled .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-row.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item.oj-disabled .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-item.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row.oj-disabled .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-row.oj-disabled .oj-hicontrast .oj-radiocheckbox-icon:before {
  content: url("images/cbsingle_dis_unselected.svg");
  width: 100%;
  height: 100%; }
...
@media print, (max-resolution: 0.99dppx) {
  ...
  .oj-checkboxset-single .oj-choice-row.oj-disabled .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-cbsingle-dis-unselected:before, .oj-choice-direction-row .oj-choice-item.oj-disabled .oj-radiocheckbox-icon:before,
  .oj-choice-direction-row .oj-choice-row.oj-disabled .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-item.oj-disabled .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-row.oj-disabled .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-item.oj-disabled .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-row.oj-disabled .oj-radiocheckbox-icon:before {
    content: url("images/cbsingle_dis_unselected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-cbsingle-ena-selected, .oj-choice-direction-row .oj-choice-item.oj-selected .oj-radiocheckbox-icon,
...
.oj-hicontrast .oj-fwk-icon-cbsingle-ena-selected, .oj-hicontrast .oj-choice-direction-row .oj-choice-item.oj-selected .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-item.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row.oj-selected .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-row.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item.oj-selected .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-item.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row.oj-selected .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-row.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item.oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-item.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row.oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-row.oj-selected .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-ena-selected:before, .oj-hicontrast .oj-choice-direction-row .oj-choice-item.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-item.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-row.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-item.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-row.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item.oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-item.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row.oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-row.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before {
...
@media print, (max-resolution: 0.99dppx) {
  ...
  .oj-checkboxset-single .oj-choice-row.oj-selected .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-cbsingle-ena-selected:before, .oj-choice-direction-row .oj-choice-item.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-direction-row .oj-choice-row.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-item.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-row.oj-selected .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-item.oj-selected .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-row.oj-selected .oj-radiocheckbox-icon:before {
    content: url("images/cbsingle_ena_selected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-cbsingle-ena-unselected, .oj-choice-direction-row .oj-choice-item .oj-radiocheckbox-icon,
...
.oj-hicontrast .oj-fwk-icon-cbsingle-ena-unselected, .oj-hicontrast .oj-choice-direction-row .oj-choice-item .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-item .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-row .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-item .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-row .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-item .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-row .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-ena-unselected:before, .oj-hicontrast .oj-choice-direction-row .oj-choice-item .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-item .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-row .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-item .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-row .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-item .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-row .oj-hicontrast .oj-radiocheckbox-icon:before {
  content: url("images/cbsingle_ena_unselected.svg");
  width: 100%;
  height: 100%; }
...
@media print, (max-resolution: 0.99dppx) {
  ...
  .oj-checkboxset-single .oj-choice-row .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-cbsingle-ena-unselected:before, .oj-choice-direction-row .oj-choice-item .oj-radiocheckbox-icon:before,
  .oj-choice-direction-row .oj-choice-row .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-item .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-row .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-item .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-row .oj-radiocheckbox-icon:before {
    content: url("images/cbsingle_ena_unselected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-cbsingle-hover-selected, .oj-checkboxset.oj-checkboxset-single .oj-hover.oj-selected:not(.oj-active) .oj-radiocheckbox-icon, .oj-selector:hover .oj-selector-wrapper.oj-selected {
  background-image: url("images/sprites/sprite.svg");
  background-size: 830px 44px;
...
.oj-hicontrast .oj-fwk-icon-cbsingle-hover-selected, .oj-hicontrast .oj-checkboxset.oj-checkboxset-single .oj-hover.oj-selected:not(.oj-active) .oj-radiocheckbox-icon, .oj-checkboxset.oj-checkboxset-single .oj-hover.oj-selected:not(.oj-active) .oj-hicontrast .oj-radiocheckbox-icon, .oj-hicontrast .oj-selector:hover .oj-selector-wrapper.oj-selected, .oj-selector:hover .oj-hicontrast .oj-selector-wrapper.oj-selected {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-hover-selected:before, .oj-hicontrast .oj-checkboxset.oj-checkboxset-single .oj-hover.oj-selected:not(.oj-active) .oj-radiocheckbox-icon:before, .oj-checkboxset.oj-checkboxset-single .oj-hover.oj-selected:not(.oj-active) .oj-hicontrast .oj-radiocheckbox-icon:before, .oj-hicontrast .oj-selector:hover .oj-selector-wrapper.oj-selected:before, .oj-selector:hover .oj-hicontrast .oj-selector-wrapper.oj-selected:before {
...
@media print, (max-resolution: 0.99dppx) {
  .oj-fwk-icon-cbsingle-hover-selected, .oj-checkboxset.oj-checkboxset-single .oj-hover.oj-selected:not(.oj-active) .oj-radiocheckbox-icon, .oj-selector:hover .oj-selector-wrapper.oj-selected {
    background-image: none; }
  .oj-fwk-icon-cbsingle-hover-selected:before, .oj-checkboxset.oj-checkboxset-single .oj-hover.oj-selected:not(.oj-active) .oj-radiocheckbox-icon:before, .oj-selector:hover .oj-selector-wrapper.oj-selected:before {
    content: url("images/cbsingle_hover_selected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-cbsingle-hover-unselected, .oj-checkboxset.oj-checkboxset-single .oj-hover:not(.oj-active) .oj-radiocheckbox-icon, .oj-selector:hover .oj-selector-wrapper:not(.oj-selected) {
  background-image: url("images/sprites/sprite.svg");
  background-size: 830px 44px;
...
.oj-hicontrast .oj-fwk-icon-cbsingle-hover-unselected, .oj-hicontrast .oj-checkboxset.oj-checkboxset-single .oj-hover:not(.oj-active) .oj-radiocheckbox-icon, .oj-checkboxset.oj-checkboxset-single .oj-hover:not(.oj-active) .oj-hicontrast .oj-radiocheckbox-icon, .oj-hicontrast .oj-selector:hover .oj-selector-wrapper:not(.oj-selected), .oj-selector:hover .oj-hicontrast .oj-selector-wrapper:not(.oj-selected) {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-hover-unselected:before, .oj-hicontrast .oj-checkboxset.oj-checkboxset-single .oj-hover:not(.oj-active) .oj-radiocheckbox-icon:before, .oj-checkboxset.oj-checkboxset-single .oj-hover:not(.oj-active) .oj-hicontrast .oj-radiocheckbox-icon:before, .oj-hicontrast .oj-selector:hover .oj-selector-wrapper:not(.oj-selected):before, .oj-selector:hover .oj-hicontrast .oj-selector-wrapper:not(.oj-selected):before {
...
@media print, (max-resolution: 0.99dppx) {
  .oj-fwk-icon-cbsingle-hover-unselected, .oj-checkboxset.oj-checkboxset-single .oj-hover:not(.oj-active) .oj-radiocheckbox-icon, .oj-selector:hover .oj-selector-wrapper:not(.oj-selected) {
    background-image: none; }
  .oj-fwk-icon-cbsingle-hover-unselected:before, .oj-checkboxset.oj-checkboxset-single .oj-hover:not(.oj-active) .oj-radiocheckbox-icon:before, .oj-selector:hover .oj-selector-wrapper:not(.oj-selected):before {
    content: url("images/cbsingle_hover_unselected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-cbsingle-pressed-selected, .oj-choice-direction-row .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon,
...
.oj-hicontrast .oj-fwk-icon-cbsingle-pressed-selected, .oj-hicontrast .oj-choice-direction-row .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-item:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-row:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-item:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon, .oj-choice-row-inline .oj-choice-row:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-item:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-row:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-pressed-selected:before, .oj-hicontrast .oj-choice-direction-row .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-item:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-row:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-item:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-row-inline .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon:before, .oj-choice-row-inline .oj-choice-row:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-item:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-row:active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before {
  content: url("images/cbsingle_pressed_selected.svg");
  width: 100%;
  height: 100%; }
...
@media print, (max-resolution: 0.99dppx) {
  ...
  .oj-checkboxset-single .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-cbsingle-pressed-selected:before, .oj-choice-direction-row .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-direction-row .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon:before,
  .oj-choice-row-inline .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-item:active.oj-selected .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-row:active.oj-selected .oj-radiocheckbox-icon:before {
    content: url("images/cbsingle_pressed_selected.svg");
    width: 100%;
    height: 100%; } }

.oj-fwk-icon-cbsingle-pressed-unselected, .oj-choice-direction-row .oj-choice-item:active .oj-radiocheckbox-icon,
...
.oj-hicontrast .oj-fwk-icon-cbsingle-pressed-unselected, .oj-hicontrast .oj-choice-direction-row .oj-choice-item:active .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-item:active .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row:active .oj-radiocheckbox-icon, .oj-choice-direction-row .oj-choice-row:active .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item:active .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-item:active .oj-hicontrast .oj-radiocheckbox-icon,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row:active .oj-radiocheckbox-icon, .oj-checkboxset-single .oj-choice-row:active .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-cbsingle-pressed-unselected:before, .oj-hicontrast .oj-choice-direction-row .oj-choice-item:active .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-item:active .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-choice-direction-row .oj-choice-row:active .oj-radiocheckbox-icon:before, .oj-choice-direction-row .oj-choice-row:active .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-item:active .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-item:active .oj-hicontrast .oj-radiocheckbox-icon:before,
.oj-hicontrast .oj-checkboxset-single .oj-choice-row:active .oj-radiocheckbox-icon:before, .oj-checkboxset-single .oj-choice-row:active .oj-hicontrast .oj-radiocheckbox-icon:before {
  content: url("images/cbsingle_pressed_unselected.svg");
  width: 100%;
  height: 100%; }
...
@media print, (max-resolution: 0.99dppx) {
  ...
  .oj-checkboxset-single .oj-choice-row:active .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-cbsingle-pressed-unselected:before, .oj-choice-direction-row .oj-choice-item:active .oj-radiocheckbox-icon:before,
  .oj-choice-direction-row .oj-choice-row:active .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-item:active .oj-radiocheckbox-icon:before,
  .oj-checkboxset-single .oj-choice-row:active .oj-radiocheckbox-icon:before {
    content: url("images/cbsingle_pressed_unselected.svg");
    width: 100%;
    height: 100%; } }
...
.oj-fwk-icon-checkbox-ena-selected, .oj-menucheckbox-icon.oj-selected::after, .oj-checkboxset .oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon {
  background-image: url("images/sprites/sprite.svg");
  background-size: 830px 44px;
...
.oj-hicontrast .oj-fwk-icon-checkbox-ena-selected, .oj-hicontrast .oj-menucheckbox-icon.oj-selected::after, .oj-hicontrast .oj-checkboxset .oj-selected .oj-radiocheckbox-icon, .oj-checkboxset .oj-selected .oj-hicontrast .oj-radiocheckbox-icon, .oj-hicontrast .oj-checkboxset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-wrapper > .oj-active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-checkbox-ena-selected:before, .oj-hicontrast .oj-checkboxset .oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset .oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before, .oj-hicontrast .oj-checkboxset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-wrapper > .oj-active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before {
...
@media print, (max-resolution: 0.99dppx) {
  .oj-fwk-icon-checkbox-ena-selected, .oj-menucheckbox-icon.oj-selected::after, .oj-checkboxset .oj-selected .oj-radiocheckbox-icon, .oj-checkboxset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-checkbox-ena-selected:before, .oj-checkboxset .oj-selected .oj-radiocheckbox-icon:before, .oj-checkboxset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon:before {
    content: url("images/checkbox_ena_selected.svg");
    width: 100%;
    height: 100%; } }
...
.oj-fwk-icon-radio-ena-selected, .oj-radioset .oj-selected .oj-radiocheckbox-icon, .oj-radioset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon {
  background-image: url("images/sprites/sprite.svg");
  background-size: 830px 44px;
...
.oj-hicontrast .oj-fwk-icon-radio-ena-selected, .oj-hicontrast .oj-radioset .oj-selected .oj-radiocheckbox-icon, .oj-radioset .oj-selected .oj-hicontrast .oj-radiocheckbox-icon, .oj-hicontrast .oj-radioset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon, .oj-radioset-wrapper > .oj-active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon {
  background-image: none; }

.oj-hicontrast .oj-fwk-icon-radio-ena-selected:before, .oj-hicontrast .oj-radioset .oj-selected .oj-radiocheckbox-icon:before, .oj-radioset .oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before, .oj-hicontrast .oj-radioset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon:before, .oj-radioset-wrapper > .oj-active.oj-selected .oj-hicontrast .oj-radiocheckbox-icon:before {
...
@media print, (max-resolution: 0.99dppx) {
  .oj-fwk-icon-radio-ena-selected, .oj-radioset .oj-selected .oj-radiocheckbox-icon, .oj-radioset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon {
    background-image: none; }
  .oj-fwk-icon-radio-ena-selected:before, .oj-radioset .oj-selected .oj-radiocheckbox-icon:before, .oj-radioset-wrapper > .oj-active.oj-selected .oj-radiocheckbox-icon:before {
    content: url("images/radio_ena_selected.svg");
    width: 100%;
    height: 100%; } }
...
.oj-menu-item > a {
  padding: 0 calc(16px + 0.75rem) 0 calc(16px + 1.5rem);
  position: relative;
  text-decoration: none;
  display: flex;
  align-items: center;
...
html:not([dir="rtl"]) a.oj-menu-option-start-icon {
  padding-left: calc(1.125rem + 24px); }

html[dir="rtl"] a.oj-menu-option-start-icon {
  padding-right: calc(1.125rem + 24px); }
...
.oj-progress-circle-overlay {
  ...
  background-image: url("images/spinner_full.gif"); }
...
.oj-dialog-header {
  ...
  display: flex;
  justify-content: space-between;
  padding: 1.4375rem 0.875rem 0.1875rem;
  background-color: transparent;
  background-image: none;
  border-bottom-color: transparent;
  font-size: 1.125rem;
...
.oj-dialog-option-defaults {
  font-family: '{"animation":{"open":[{"effect":"zoomIn"},"fadeIn"],"close":[{"effect":"zoomOut"},"fadeOut"]},"resizeBehavior":"none","cancelBehavior":"none","dragAffordance":"none"}'; }
...
.oj-table-element:not(.oj-table-column-header-resizing) .oj-table-footer-cell.oj-selected {
  background-image: linear-gradient(#b3d7ee, #b3d7ee); }
...
html:not([dir="rtl"]) .oj-table-editable .oj-table-column-header-cell.oj-table-sort .oj-table-column-header-text {
  padding-right: calc(16px + 0.625rem); }
...
.oj-table-element:not(.oj-table-column-header-resizing) .oj-table-column-header-cell.oj-selected.oj-hover .oj-table-sort-icon-container {
  background-image: linear-gradient(to right, rgba(179, 215, 238, 0), #b3d7ee 40%); }
  html[dir="rtl"] .oj-table-element:not(.oj-table-column-header-resizing) .oj-table-column-header-cell.oj-selected.oj-hover .oj-table-sort-icon-container {
    background-image: linear-gradient(to left, rgba(179, 215, 238, 0), #b3d7ee 40%); }
...
.oj-checkboxset .oj-choice-row {
  ...
  box-sizing: border-box;
  border-top: 1px solid transparent; }
  html:not([dir="rtl"]) .oj-radioset.oj-choice-direction-column .oj-choice-item, html:not([dir="rtl"])
  .oj-checkboxset.oj-choice-direction-column .oj-choice-item, html:not([dir="rtl"])
  .oj-radioset .oj-choice-row, html:not([dir="rtl"])
  .oj-checkboxset .oj-choice-row {
    background-position: 10px 0; }
  html[dir="rtl"] .oj-radioset.oj-choice-direction-column .oj-choice-item, html[dir="rtl"]
  .oj-checkboxset.oj-choice-direction-column .oj-choice-item, html[dir="rtl"]
  .oj-radioset .oj-choice-row, html[dir="rtl"]
  .oj-checkboxset .oj-choice-row {
    background-position: -10px 0; }

html:not([dir="rtl"]) .oj-radioset-input-start.oj-choice-direction-column .oj-choice-item, html:not([dir="rtl"])
.oj-checkboxset-input-start.oj-choice-direction-column .oj-choice-item, html:not([dir="rtl"])
.oj-radioset-input-start .oj-choice-row, html:not([dir="rtl"])
.oj-checkboxset-input-start .oj-choice-row {
  background-position: 36px 0; }

html[dir="rtl"] .oj-radioset-input-start.oj-choice-direction-column .oj-choice-item, html[dir="rtl"]
.oj-checkboxset-input-start.oj-choice-direction-column .oj-choice-item, html[dir="rtl"]
.oj-radioset-input-start .oj-choice-row, html[dir="rtl"]
.oj-checkboxset-input-start .oj-choice-row {
  background-position: -36px 0; }

html:not([dir="rtl"]) .oj-radioset-input-end.oj-choice-direction-column .oj-choice-item, html:not([dir="rtl"])
.oj-checkboxset-input-end.oj-choice-direction-column .oj-choice-item, html:not([dir="rtl"])
.oj-radioset-input-end .oj-choice-row, html:not([dir="rtl"])
.oj-checkboxset-input-end .oj-choice-row {
  background-position: 10px 0; }

html[dir="rtl"] .oj-radioset-input-end.oj-choice-direction-column .oj-choice-item, html[dir="rtl"]
.oj-checkboxset-input-end.oj-choice-direction-column .oj-choice-item, html[dir="rtl"]
.oj-radioset-input-end .oj-choice-row, html[dir="rtl"]
.oj-checkboxset-input-end .oj-choice-row {
  background-position: -10px 0; }
...
.oj-form-layout-option-defaults {
  font-family: '{"labelEdge":"top","colspanWrap":"nowrap","direction":"column","columnGap":"1.25rem"}'; }
...
.oj-inputdatetime-option-defaults {
  font-family: '{"renderMode":"native","keyboardEdit":"disabled","datePicker":{"footerLayout":"today"},"converterYear":"2-digit","showPickerOnDesktop":"enabled"}'; }
...
.oj-select-option-defaults {
  font-family: '{"renderMode":"native","loadingIndicatorDelay":"250"}'; }
...
.oj-switch .oj-switch-track {
  ...
  border-style: solid;
  border-width: 2px;
  height: calc(1.87492rem - 4px);
  width: calc(3.18757rem - 4px);
  margin-top: -0.93746rem;
  border-radius: 1.87492rem; }
...
.oj-switch.oj-default .oj-switch-thumb {
  ...
  border-style: solid;
  border-width: 1px;
  height: calc(1.62498rem - 2px);
  width: calc(1.62498rem - 2px);
  margin-top: -0.81249rem;
  border-radius: 1.62498rem;
  box-shadow: 0 3px 1px hsla(0, 0%, 0%,0.05), 0 0 8px hsla(0, 0%, 0%,0.05);
  background-color: white;
  border-color: #cbcccd; }
...
.oj-switch.oj-hover .oj-switch-thumb {
  ...
  border-style: solid;
  border-width: 1px;
  height: calc(2.12505rem - 2px);
  width: calc(2.12505rem - 2px);
  margin-top: -1.06252rem;
  border-radius: 2.12505rem;
  box-shadow: none;
  background-color: #e8f3fa;
  border-color: #b3d7ee; }
...
.oj-slider-thumb {
  ...
  box-shadow: 0 3px 1px hsla(0, 0%, 0%,0.05), 0 0 8px hsla(0, 0%, 0%,0.2); }
...
.oj-progressstatus-done-icon {
  background-size: 398.4px 62.4px;
  background-position: -223.2px -2.4px;
  width: 24px;
  height: 24px; }

.oj-progressstatus-error-icon {
  background-size: 398.4px 62.4px;
  background-position: -267.6px -2.4px;
  width: 24px;
  height: 24px; }
