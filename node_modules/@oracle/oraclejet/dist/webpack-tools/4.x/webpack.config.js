...
module.exports = {
  ...
  resolve: {
    alias: {
      ...
      'ojs': path.resolve(__dirname, './web/js/libs/oj/15.1.5/debug'),
      'ojtranslations': path.resolve(__dirname, './web/js/libs/oj/15.1.5/resources'),
    ...
    new WebpackRequireFixupPlugin(
      {
        ...
        baseResourceUrl: "./web/js/libs/oj/15.1.5"
      }
    )
