<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>default | @oracle/oraclejet-webdriver - v15.1.5</title><meta name="description" content="Documentation for @oracle/oraclejet-webdriver"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="index.default.html">default</a></li></ul>
<h1>Variable default<code class="tsd-tag ts-flagConst">Const</code> </h1></div>
<div class="tsd-signature"><span class="tsd-kind-variable">default</span><span class="tsd-signature-symbol">:</span> <span class="tsd-signature-symbol">{ </span><br/><span>    </span><span class="tsd-kind-call-signature">assertViewModelValue</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">vmLocator</span>, <span class="tsd-kind-parameter">expectation</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-call-signature">fetch</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">requestInfo</span>, <span class="tsd-kind-parameter">responseInfo</span>, <span class="tsd-kind-parameter">init</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">MarshaledResponse</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-call-signature">get</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">url</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-call-signature">pageReady</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type ">Condition</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">; </span><br/><span>    </span><span class="tsd-kind-call-signature">waitAndFindElement</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">by</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol"> =&gt; </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">WebElement</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">; </span><br/><span class="tsd-signature-symbol">}</span><span class="tsd-signature-symbol"> = ...</span></div>
<div class="tsd-comment tsd-typography"><p>The test utility object for JET component WebElements.  This object contains
...
<h5><span class="tsd-kind-method">assert<wbr/>View<wbr/>Model<wbr/>Value</span><span class="tsd-signature-symbol">:</span>function</h5>
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="__type.assertViewModelValue.assertViewModelValue-1"><span class="tsd-kind-call-signature">assert<wbr/>View<wbr/>Model<wbr/>Value</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">vmLocator</span>, <span class="tsd-kind-parameter">expectation</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span><a href="#__type.assertViewModelValue.assertViewModelValue-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none" id="icon-anchor-a"></path><path d="M10 14a3.5 3.5 0 0 0 5 0l4 -4a3.5 3.5 0 0 0 -5 -5l-.5 .5" id="icon-anchor-b"></path><path d="M14 10a3.5 3.5 0 0 0 -5 0l-4 4a3.5 3.5 0 0 0 5 5l.5 -.5" id="icon-anchor-c"></path></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Assert a given expectation against a JET application&#39;s viewmodel.
Assertions are <a href="https://www.chaijs.com">Chai</a>-like expressions, represented
by the <a href="../classes/index.Expectation.html" class="tsd-kind-class">Expectation</a> class, and compared remotely on the test browser
against the identified viewmodel and its path to the target value.</p>
...
<li>
<h5><span class="tsd-kind-parameter">driver</span>: <span class="tsd-signature-type ">WebDriver</span></h5>
<div class="tsd-comment tsd-typography"><p>The instance of WebDriver to use in performing the expectation</p>
</div></li>
<li>
<h5><span class="tsd-kind-parameter">vmLocator</span>: <span class="tsd-signature-type ">Locator</span></h5>
<div class="tsd-comment tsd-typography"><p>The Locator which identifies the DOM node associated with the
viewmodel on the client.</p>
</div></li>
<li>
<h5><span class="tsd-kind-parameter">expectation</span>: <a href="../classes/index.Expectation.html" class="tsd-signature-type tsd-kind-class">Expectation</a><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></h5>
<div class="tsd-comment tsd-typography"><p>The Expectation object to evaluate on the client browser.</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">any</span><span class="tsd-signature-symbol">&gt;</span></h4></li></ul></li>
<li class="tsd-parameter">
<h5><span class="tsd-kind-method">fetch</span><span class="tsd-signature-symbol">:</span>function</h5>
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="__type.fetch.fetch-1"><span class="tsd-kind-call-signature">fetch</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">requestInfo</span>, <span class="tsd-kind-parameter">responseInfo</span>, <span class="tsd-kind-parameter">init</span><span class="tsd-signature-symbol">?</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">MarshaledResponse</span><span class="tsd-signature-symbol">&gt;</span><a href="#__type.fetch.fetch-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Invoke fetch in the browser to permit interaction with REST services.
Browsers must support fetch api.</p>
<p>The fetch parameters mirror the MDN fetch api
<a href="https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch#Parameters">https://developer.mozilla.org/en-US/docs/Web/API/WindowOrWorkerGlobalScope/fetch#Parameters</a></p>
<p>Note the return value is not the typical Response object, to accommodate webdriver marshalling.</p>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">driver</span>: <span class="tsd-signature-type ">WebDriver</span></h5>
<div class="tsd-comment tsd-typography"><p>A WebDriver-like object</p>
</div></li>
<li>
<h5><span class="tsd-kind-parameter">requestInfo</span>: <span class="tsd-signature-type">string</span></h5></li>
<li>
<h5><span class="tsd-kind-parameter">responseInfo</span>: <span class="tsd-signature-type ">MarshalableResponseInfo</span></h5>
<div class="tsd-comment tsd-typography"><p>Indicates the desired structure of the response body, text or json</p>
</div></li>
<li>
<h5><code class="tsd-tag ts-flagOptional">Optional</code> <span class="tsd-kind-parameter">init</span>: <span class="tsd-signature-type ">MarshalableRequestInit</span></h5>
<div class="tsd-comment tsd-typography"><p>Optional
...
<li class="tsd-parameter">
<h5><span class="tsd-kind-method">get</span><span class="tsd-signature-symbol">:</span>function</h5>
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="__type.get.get-1"><span class="tsd-kind-call-signature">get</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">url</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span><a href="#__type.get.get-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Opens a JET page and wait for the UI to be ready for testing. This method
...
timing out waiting for RequireJS to become available.</p>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">driver</span>: <span class="tsd-signature-type ">WebDriver</span></h5>
<div class="tsd-comment tsd-typography"><p>The WebDriver instance</p>
</div></li>
<li>
<h5><span class="tsd-kind-parameter">url</span>: <span class="tsd-signature-type">string</span></h5>
<div class="tsd-comment tsd-typography"><p>The URL to open</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4></li></ul></li>
<li class="tsd-parameter">
<h5><span class="tsd-kind-method">page<wbr/>Ready</span><span class="tsd-signature-symbol">:</span>function</h5>
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="__type.pageReady.pageReady-1"><span class="tsd-kind-call-signature">page<wbr/>Ready</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Condition</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">&gt;</span><a href="#__type.pageReady.pageReady-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Condition</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span><span class="tsd-signature-symbol">&gt;</span></h4></li></ul></li>
<li class="tsd-parameter">
<h5><span class="tsd-kind-method">wait<wbr/>And<wbr/>Find<wbr/>Element</span><span class="tsd-signature-symbol">:</span>function</h5>
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="__type.waitAndFindElement.waitAndFindElement-1"><span class="tsd-kind-call-signature">wait<wbr/>And<wbr/>Find<wbr/>Element</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">driver</span>, <span class="tsd-kind-parameter">by</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">WebElement</span><span class="tsd-signature-symbol">&gt;</span><a href="#__type.waitAndFindElement.waitAndFindElement-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>This is a convenience function to allow either WebDriver or WebElement to
be passed as the driver and the search to be performed using that object.</p>

<h3>Deprecated</h3><p>Since 11.0.0 This method is equivalient to calling
driver.findElement(by)</p>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
...
<div class="tsd-comment tsd-typography"><p>A WebDriver-like object, either WebDriver itself or a
WebElement. The target element will be searched using this driver.</p>
</div></li>
<li>
<h5><span class="tsd-kind-parameter">by</span>: <span class="tsd-signature-type ">By</span></h5>
<div class="tsd-comment tsd-typography"><p>The locator by which to find the element</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">WebElement</span><span class="tsd-signature-symbol">&gt;</span></h4></li></ul></li></ul></div></div>
...
<li>
<ul>
<li><a href="#md:example-of-read-and-update-operations"><span>Example of READ and UPDATE operations</span></a></li>
<li>
<ul>
<li><a href="#md:example-of-create-and-delete-operations"><span>Example of CREATE and DELETE operations</span></a></li>
<li>
<ul>
<li><a href="#md:example-of-checking-for-row-deleted-operation"><span>Example of <wbr/>Checking for row deleted operation</span></a></li>
<li>
<ul>
