<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>OjRatingGauge | @oracle/oraclejet-webdriver - v15.1.5</title><meta name="description" content="Documentation for @oracle/oraclejet-webdriver"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="elements.OjRatingGauge.html">OjRatingGauge</a></li></ul>
<h1>Class OjRatingGauge</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>The component WebElement for <a href="../../jsdocs/oj.ojRatingGauge.html">oj-rating-gauge</a>.
...
<li><span class="tsd-signature-type ">OjRatingGaugeBase</span>
<ul class="tsd-hierarchy">
<li><span class="target">OjRatingGauge</span></li></ul></li></ul></section>
...
<div class="tsd-index-list"><a href="elements.OjRatingGauge.html#constructor" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><rect fill="var(--color-icon-background)" stroke="#4D7FFF" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12" id="icon-512-path"></rect><path d="M11.898 16.1201C11.098 16.1201 10.466 15.8961 10.002 15.4481C9.53803 15.0001 9.30603 14.3841 9.30603 13.6001V9.64012C9.30603 8.85612 9.53803 8.24012 10.002 7.79212C10.466 7.34412 11.098 7.12012 11.898 7.12012C12.682 7.12012 13.306 7.34812 13.77 7.80412C14.234 8.25212 14.466 8.86412 14.466 9.64012H13.386C13.386 9.14412 13.254 8.76412 12.99 8.50012C12.734 8.22812 12.37 8.09212 11.898 8.09212C11.426 8.09212 11.054 8.22412 10.782 8.48812C10.518 8.75212 10.386 9.13212 10.386 9.62812V13.6001C10.386 14.0961 10.518 14.4801 10.782 14.7521C11.054 15.0161 11.426 15.1481 11.898 15.1481C12.37 15.1481 12.734 15.0161 12.99 14.7521C13.254 14.4801 13.386 14.0961 13.386 13.6001H14.466C14.466 14.3761 14.234 14.9921 13.77 15.4481C13.306 15.8961 12.682 16.1201 11.898 16.1201Z" fill="var(--color-text)" id="icon-512-text"></path></svg><span>constructor</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Methods</h3>
<div class="tsd-index-list"><a href="elements.OjRatingGauge.html#changeChanged" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><rect fill="var(--color-icon-background)" stroke="#FF4DB8" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12" id="icon-2048-path"></rect><path d="M9.162 16V7.24H10.578L11.514 10.072C11.602 10.328 11.674 10.584 11.73 10.84C11.794 11.088 11.842 11.28 11.874 11.416C11.906 11.28 11.954 11.088 12.018 10.84C12.082 10.584 12.154 10.324 12.234 10.06L13.122 7.24H14.538V16H13.482V12.82C13.482 12.468 13.49 12.068 13.506 11.62C13.53 11.172 13.558 10.716 13.59 10.252C13.622 9.78 13.654 9.332 13.686 8.908C13.726 8.476 13.762 8.1 13.794 7.78L12.366 12.16H11.334L9.894 7.78C9.934 8.092 9.97 8.456 10.002 8.872C10.042 9.28 10.078 9.716 10.11 10.18C10.142 10.636 10.166 11.092 10.182 11.548C10.206 12.004 10.218 12.428 10.218 12.82V16H9.162Z" fill="var(--color-text)" id="icon-2048-text"></path></svg><span>change<wbr/>Changed</span></a>
<a href="elements.OjRatingGauge.html#changeValue" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>change<wbr/>Value</span></a>
<a href="elements.OjRatingGauge.html#clear" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>clear</span></a>
<a href="elements.OjRatingGauge.html#click" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>click</span></a>
<a href="elements.OjRatingGauge.html#findElement" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>find<wbr/>Element</span></a>
<a href="elements.OjRatingGauge.html#findElements" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>find<wbr/>Elements</span></a>
<a href="elements.OjRatingGauge.html#getAttribute" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Attribute</span></a>
<a href="elements.OjRatingGauge.html#getChanged" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Changed</span></a>
<a href="elements.OjRatingGauge.html#getChangedState" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Changed<wbr/>State</span></a>
<a href="elements.OjRatingGauge.html#getCssValue" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Css<wbr/>Value</span></a>
<a href="elements.OjRatingGauge.html#getDescribedBy" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Described<wbr/>By</span></a>
<a href="elements.OjRatingGauge.html#getDisabled" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Disabled</span></a>
<a href="elements.OjRatingGauge.html#getDriver" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Driver</span></a>
<a href="elements.OjRatingGauge.html#getHoverState" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Hover<wbr/>State</span></a>
<a href="elements.OjRatingGauge.html#getId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Id</span></a>
<a href="elements.OjRatingGauge.html#getLabelledBy" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Labelled<wbr/>By</span></a>
<a href="elements.OjRatingGauge.html#getLocation" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Location</span></a>
<a href="elements.OjRatingGauge.html#getMax" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Max</span></a>
<a href="elements.OjRatingGauge.html#getMin" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Min</span></a>
<a href="elements.OjRatingGauge.html#getOrientation" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Orientation</span></a>
<a href="elements.OjRatingGauge.html#getPreserveAspectRatio" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Preserve<wbr/>Aspect<wbr/>Ratio</span></a>
<a href="elements.OjRatingGauge.html#getProperty" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Property</span></a>
<a href="elements.OjRatingGauge.html#getReadonly" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Readonly</span></a>
<a href="elements.OjRatingGauge.html#getRect" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Rect</span></a>
<a href="elements.OjRatingGauge.html#getSelectedState" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Selected<wbr/>State</span></a>
<a href="elements.OjRatingGauge.html#getShadowRoot" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Shadow<wbr/>Root</span></a>
<a href="elements.OjRatingGauge.html#getSize" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Size</span></a>
<a href="elements.OjRatingGauge.html#getSizeProperty" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Size<wbr/>Property</span></a>
<a href="elements.OjRatingGauge.html#getStep" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Step</span></a>
<a href="elements.OjRatingGauge.html#getTagName" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Tag<wbr/>Name</span></a>
<a href="elements.OjRatingGauge.html#getText" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Text</span></a>
<a href="elements.OjRatingGauge.html#getThresholds" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Thresholds</span></a>
<a href="elements.OjRatingGauge.html#getTooltip" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Tooltip</span></a>
<a href="elements.OjRatingGauge.html#getTrackResize" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Track<wbr/>Resize</span></a>
<a href="elements.OjRatingGauge.html#getTransientValue" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Transient<wbr/>Value</span></a>
<a href="elements.OjRatingGauge.html#getTranslations" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Translations</span></a>
<a href="elements.OjRatingGauge.html#getUnselectedState" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Unselected<wbr/>State</span></a>
<a href="elements.OjRatingGauge.html#getValue" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Value</span></a>
<a href="elements.OjRatingGauge.html#getVisualEffects" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Visual<wbr/>Effects</span></a>
<a href="elements.OjRatingGauge.html#hasSize" class="tsd-index-link tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>has<wbr/>Size</span></a>
<a href="elements.OjRatingGauge.html#hasVisibility" class="tsd-index-link tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>has<wbr/>Visibility</span></a>
<a href="elements.OjRatingGauge.html#isDisplayed" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Displayed</span></a>
<a href="elements.OjRatingGauge.html#isEnabled" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Enabled</span></a>
<a href="elements.OjRatingGauge.html#isSelected" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Selected</span></a>
<a href="elements.OjRatingGauge.html#sendKeys" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>send<wbr/>Keys</span></a>
<a href="elements.OjRatingGauge.html#serialize" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>serialize</span></a>
<a href="elements.OjRatingGauge.html#setProperty" class="tsd-index-link tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>set<wbr/>Property</span></a>
<a href="elements.OjRatingGauge.html#submit" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>submit</span></a>
<a href="elements.OjRatingGauge.html#takeScreenshot" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>take<wbr/>Screenshot</span></a>
<a href="elements.OjRatingGauge.html#whenBusyContextReady" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>when<wbr/>Busy<wbr/>Context<wbr/>Ready</span></a>
<a href="elements.OjRatingGauge.html#whenReady" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>when<wbr/>Ready</span></a>
<a href="elements.OjRatingGauge.html#buildId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>build<wbr/>Id</span></a>
<a href="elements.OjRatingGauge.html#equals" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>equals</span></a>
<a href="elements.OjRatingGauge.html#extractId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>extract<wbr/>Id</span></a>
<a href="elements.OjRatingGauge.html#isId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Id</span></a>
...
<li class="tsd-signature tsd-anchor-link" id="constructor.new_OjRatingGauge"><span class="tsd-kind-constructor-signature">new <wbr/>Oj<wbr/>Rating<wbr/>Gauge</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">el</span>, <span class="tsd-kind-parameter">locators</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="elements.OjRatingGauge.html" class="tsd-signature-type tsd-kind-class">OjRatingGauge</a><a href="#constructor.new_OjRatingGauge" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
...
<h4 class="tsd-returns-title">Returns <a href="elements.OjRatingGauge.html" class="tsd-signature-type tsd-kind-class">OjRatingGauge</a></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.constructor</p></aside></li></ul></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>Methods</h2>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="changeChanged" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>change<wbr/>Changed</span><a href="#changeChanged" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="changeChanged.changeChanged-1"><span class="tsd-kind-call-signature">change<wbr/>Changed</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">changed</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span><a href="#changeChanged.changeChanged-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Sets the value of <code>changed</code> property.
...
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">changed</span>: <span class="tsd-signature-type">boolean</span></h5>
<div class="tsd-comment tsd-typography"><p>The value to set for <code>changed</code></p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.changeChanged</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.changeValue</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.clear</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.click</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.findElement</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.findElements</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.getAttribute</p></aside></li></ul></section>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="getChanged" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>get<wbr/>Changed</span><a href="#getChanged" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getChanged.getChanged-1"><span class="tsd-kind-call-signature">get<wbr/>Changed</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span><a href="#getChanged.getChanged-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Gets the value of <code>changed</code> property.
Whether there has been a value entered by the user.</p>
</div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>changed</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getChanged</p></aside></li></ul></section>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="getChangedState" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>get<wbr/>Changed<wbr/>State</span><a href="#getChangedState" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getChangedState.getChangedState-1"><span class="tsd-kind-call-signature">get<wbr/>Changed<wbr/>State</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">ChangedState</span><span class="tsd-signature-symbol">&gt;</span><a href="#getChangedState.getChangedState-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Gets the value of <code>changedState</code> property.
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">ChangedState</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>changedState</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getChangedState</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getCssValue</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getDescribedBy</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getDisabled</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getDriver</p></aside></li></ul></section>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="getHoverState" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>get<wbr/>Hover<wbr/>State</span><a href="#getHoverState" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getHoverState.getHoverState-1"><span class="tsd-kind-call-signature">get<wbr/>Hover<wbr/>State</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">HoverState</span><span class="tsd-signature-symbol">&gt;</span><a href="#getHoverState.getHoverState-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Gets the value of <code>hoverState</code> property.
The shape that displays on hover.</p>

<h3>Deprecated</h3><p>Since 14.0.0. This is not recommended in the Redwood design system.</p>
</div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">HoverState</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>hoverState</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getHoverState</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getId</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getLabelledBy</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.getLocation</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getMax</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getMin</p></aside></li></ul></section>
...
<h3>Deprecated</h3><p>Since 9.0.0. Usage of vertical rating gauges is not recommended.</p>
</div>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getOrientation</p></aside></li></ul></section>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="getPreserveAspectRatio" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>get<wbr/>Preserve<wbr/>Aspect<wbr/>Ratio</span><a href="#getPreserveAspectRatio" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getPreserveAspectRatio.getPreserveAspectRatio-1"><span class="tsd-kind-call-signature">get<wbr/>Preserve<wbr/>Aspect<wbr/>Ratio</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span><a href="#getPreserveAspectRatio.getPreserveAspectRatio-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Gets the value of <code>preserveAspectRatio</code> property.
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>preserveAspectRatio</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getPreserveAspectRatio</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getProperty</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getReadonly</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.getRect</p></aside></li></ul></section>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="getSelectedState" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>get<wbr/>Selected<wbr/>State</span><a href="#getSelectedState" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getSelectedState.getSelectedState-1"><span class="tsd-kind-call-signature">get<wbr/>Selected<wbr/>State</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">SelectedState</span><span class="tsd-signature-symbol">&gt;</span><a href="#getSelectedState.getSelectedState-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Gets the value of <code>selectedState</code> property.
The selected shape for the gauge.</p>
</div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">SelectedState</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>selectedState</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getSelectedState</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getShadowRoot</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.getSize</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getSizeProperty</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getStep</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getTagName</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getText</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getThresholds</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getTooltip</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getTrackResize</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getTransientValue</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getTranslations</p></aside></li></ul></section>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="getUnselectedState" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>get<wbr/>Unselected<wbr/>State</span><a href="#getUnselectedState" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getUnselectedState.getUnselectedState-1"><span class="tsd-kind-call-signature">get<wbr/>Unselected<wbr/>State</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">UnselectedState</span><span class="tsd-signature-symbol">&gt;</span><a href="#getUnselectedState.getUnselectedState-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Gets the value of <code>unselectedState</code> property.
The unselected shape for the gauge.</p>

<h3>Deprecated</h3><p>Since 14.0.0. This is not recommended in the Redwood design system.</p>
</div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">UnselectedState</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>unselectedState</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getUnselectedState</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getValue</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.getVisualEffects</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.hasSize</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.hasVisibility</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.isDisplayed</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.isEnabled</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.isSelected</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.sendKeys</p></aside></li></ul></section>
...
<p>Inherited from OjRatingGaugeBase.serialize</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.setProperty</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.submit</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.takeScreenshot</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.whenBusyContextReady</p></aside></li></ul></section>
...
are met.</p>
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.whenReady</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.buildId</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.equals</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.extractId</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjRatingGaugeBase.isId</p></aside></li></ul></section></section></div>
...
<li><a href="#changeChanged" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>change<wbr/>Changed</span></a></li>
...
<li><a href="#getChanged" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Changed</span></a></li>
<li><a href="#getChangedState" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Changed<wbr/>State</span></a></li>
...
<li><a href="#getHoverState" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Hover<wbr/>State</span></a></li>
...
<li><a href="#getPreserveAspectRatio" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Preserve<wbr/>Aspect<wbr/>Ratio</span></a></li>
...
<li><a href="#getSelectedState" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Selected<wbr/>State</span></a></li>
...
<li><a href="#getUnselectedState" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Unselected<wbr/>State</span></a></li>
...
<li><a href="elements.OjRatingGauge.html" class="current"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-128-path"></use><use href="#icon-128-text"></use></svg><span>Oj<wbr/>Rating<wbr/>Gauge</span></a></li>
