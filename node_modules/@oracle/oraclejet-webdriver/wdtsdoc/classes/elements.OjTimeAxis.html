...
<li><a href="elements.OjTimeAxis.html">OjTimeAxis</a></li></ul>
<h1>Class OjTimeAxis</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>The component WebElement for <a href="../../jsdocs/oj.ojTimeAxis.html">oj-time-axis</a>.
...
<li><span class="tsd-signature-type ">OjTimeAxisBase</span>
<ul class="tsd-hierarchy">
<li><span class="target">OjTimeAxis</span></li></ul></li></ul></section>
...
<div class="tsd-index-list"><a href="elements.OjTimeAxis.html#constructor" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><rect fill="var(--color-icon-background)" stroke="#4D7FFF" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12" id="icon-512-path"></rect><path d="M11.898 16.1201C11.098 16.1201 10.466 15.8961 10.002 15.4481C9.53803 15.0001 9.30603 14.3841 9.30603 13.6001V9.64012C9.30603 8.85612 9.53803 8.24012 10.002 7.79212C10.466 7.34412 11.098 7.12012 11.898 7.12012C12.682 7.12012 13.306 7.34812 13.77 7.80412C14.234 8.25212 14.466 8.86412 14.466 9.64012H13.386C13.386 9.14412 13.254 8.76412 12.99 8.50012C12.734 8.22812 12.37 8.09212 11.898 8.09212C11.426 8.09212 11.054 8.22412 10.782 8.48812C10.518 8.75212 10.386 9.13212 10.386 9.62812V13.6001C10.386 14.0961 10.518 14.4801 10.782 14.7521C11.054 15.0161 11.426 15.1481 11.898 15.1481C12.37 15.1481 12.734 15.0161 12.99 14.7521C13.254 14.4801 13.386 14.0961 13.386 13.6001H14.466C14.466 14.3761 14.234 14.9921 13.77 15.4481C13.306 15.8961 12.682 16.1201 11.898 16.1201Z" fill="var(--color-text)" id="icon-512-text"></path></svg><span>constructor</span></a>
</div></section>
<section class="tsd-index-section">
<h3 class="tsd-index-heading">Methods</h3>
<div class="tsd-index-list"><a href="elements.OjTimeAxis.html#clear" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><rect fill="var(--color-icon-background)" stroke="#FF4DB8" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12" id="icon-2048-path"></rect><path d="M9.162 16V7.24H10.578L11.514 10.072C11.602 10.328 11.674 10.584 11.73 10.84C11.794 11.088 11.842 11.28 11.874 11.416C11.906 11.28 11.954 11.088 12.018 10.84C12.082 10.584 12.154 10.324 12.234 10.06L13.122 7.24H14.538V16H13.482V12.82C13.482 12.468 13.49 12.068 13.506 11.62C13.53 11.172 13.558 10.716 13.59 10.252C13.622 9.78 13.654 9.332 13.686 8.908C13.726 8.476 13.762 8.1 13.794 7.78L12.366 12.16H11.334L9.894 7.78C9.934 8.092 9.97 8.456 10.002 8.872C10.042 9.28 10.078 9.716 10.11 10.18C10.142 10.636 10.166 11.092 10.182 11.548C10.206 12.004 10.218 12.428 10.218 12.82V16H9.162Z" fill="var(--color-text)" id="icon-2048-text"></path></svg><span>clear</span></a>
<a href="elements.OjTimeAxis.html#click" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>click</span></a>
<a href="elements.OjTimeAxis.html#findElement" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>find<wbr/>Element</span></a>
<a href="elements.OjTimeAxis.html#findElements" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>find<wbr/>Elements</span></a>
<a href="elements.OjTimeAxis.html#getAttribute" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Attribute</span></a>
<a href="elements.OjTimeAxis.html#getConverter" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Converter</span></a>
<a href="elements.OjTimeAxis.html#getCssValue" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Css<wbr/>Value</span></a>
<a href="elements.OjTimeAxis.html#getDriver" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Driver</span></a>
<a href="elements.OjTimeAxis.html#getEnd" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>End</span></a>
<a href="elements.OjTimeAxis.html#getId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Id</span></a>
<a href="elements.OjTimeAxis.html#getLocation" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Location</span></a>
<a href="elements.OjTimeAxis.html#getProperty" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Property</span></a>
<a href="elements.OjTimeAxis.html#getRect" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Rect</span></a>
<a href="elements.OjTimeAxis.html#getScale" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Scale</span></a>
<a href="elements.OjTimeAxis.html#getShadowRoot" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Shadow<wbr/>Root</span></a>
<a href="elements.OjTimeAxis.html#getSize" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Size</span></a>
<a href="elements.OjTimeAxis.html#getStart" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Start</span></a>
<a href="elements.OjTimeAxis.html#getTagName" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Tag<wbr/>Name</span></a>
<a href="elements.OjTimeAxis.html#getText" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Text</span></a>
<a href="elements.OjTimeAxis.html#getTrackResize" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Track<wbr/>Resize</span></a>
<a href="elements.OjTimeAxis.html#getTranslations" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Translations</span></a>
<a href="elements.OjTimeAxis.html#hasSize" class="tsd-index-link tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>has<wbr/>Size</span></a>
<a href="elements.OjTimeAxis.html#hasVisibility" class="tsd-index-link tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>has<wbr/>Visibility</span></a>
<a href="elements.OjTimeAxis.html#isDisplayed" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Displayed</span></a>
<a href="elements.OjTimeAxis.html#isEnabled" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Enabled</span></a>
<a href="elements.OjTimeAxis.html#isSelected" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Selected</span></a>
<a href="elements.OjTimeAxis.html#sendKeys" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>send<wbr/>Keys</span></a>
<a href="elements.OjTimeAxis.html#serialize" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>serialize</span></a>
<a href="elements.OjTimeAxis.html#setProperty" class="tsd-index-link tsd-is-protected tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>set<wbr/>Property</span></a>
<a href="elements.OjTimeAxis.html#submit" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>submit</span></a>
<a href="elements.OjTimeAxis.html#takeScreenshot" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>take<wbr/>Screenshot</span></a>
<a href="elements.OjTimeAxis.html#whenBusyContextReady" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>when<wbr/>Busy<wbr/>Context<wbr/>Ready</span></a>
<a href="elements.OjTimeAxis.html#whenReady" class="tsd-index-link tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>when<wbr/>Ready</span></a>
<a href="elements.OjTimeAxis.html#buildId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>build<wbr/>Id</span></a>
<a href="elements.OjTimeAxis.html#equals" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>equals</span></a>
<a href="elements.OjTimeAxis.html#extractId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>extract<wbr/>Id</span></a>
<a href="elements.OjTimeAxis.html#isId" class="tsd-index-link tsd-is-inherited tsd-is-external"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>is<wbr/>Id</span></a>
...
<li class="tsd-signature tsd-anchor-link" id="constructor.new_OjTimeAxis"><span class="tsd-kind-constructor-signature">new <wbr/>Oj<wbr/>Time<wbr/>Axis</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">el</span>, <span class="tsd-kind-parameter">locators</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><a href="elements.OjTimeAxis.html" class="tsd-signature-type tsd-kind-class">OjTimeAxis</a><a href="#constructor.new_OjTimeAxis" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
...
<h4 class="tsd-returns-title">Returns <a href="elements.OjTimeAxis.html" class="tsd-signature-type tsd-kind-class">OjTimeAxis</a></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.constructor</p></aside></li></ul></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>Methods</h2>
...
<p>Inherited from OjTimeAxisBase.clear</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.click</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.findElement</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.findElements</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.getAttribute</p></aside></li></ul></section>
...
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getConverter.getConverter-1"><span class="tsd-kind-call-signature">get<wbr/>Converter</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">Converter</span><span class="tsd-signature-symbol">&gt;</span><a href="#getConverter.getConverter-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">Converter</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>converter</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getConverter</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getCssValue</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getDriver</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getEnd</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getId</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.getLocation</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getProperty</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.getRect</p></aside></li></ul></section>
<section class="tsd-panel tsd-member tsd-is-inherited"><a id="getScale" class="tsd-anchor"></a>
<h3 class="tsd-anchor-link"><span>get<wbr/>Scale</span><a href="#getScale" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></h3>
<ul class="tsd-signatures tsd-is-inherited">
<li class="tsd-signature tsd-anchor-link" id="getScale.getScale-1"><span class="tsd-kind-call-signature">get<wbr/>Scale</span><span class="tsd-signature-symbol">(</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span><a href="#getScale.getScale-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Gets the value of <code>scale</code> property.
The time scale used for the time axis.</p>
</div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><p>The value of <code>scale</code> property.</p>
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getScale</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getShadowRoot</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.getSize</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getStart</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getTagName</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getText</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getTrackResize</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.getTranslations</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.hasSize</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.hasVisibility</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.isDisplayed</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.isEnabled</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">boolean</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.isSelected</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.sendKeys</p></aside></li></ul></section>
...
<p>Inherited from OjTimeAxisBase.serialize</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.setProperty</p></aside></li></ul></section>
...
<h3>Inherit Doc</h3></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">void</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.submit</p></aside></li></ul></section>
...
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type">string</span><span class="tsd-signature-symbol">&gt;</span></h4><aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.takeScreenshot</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.whenBusyContextReady</p></aside></li></ul></section>
...
are met.</p>
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.whenReady</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.buildId</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.equals</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.extractId</p></aside></li></ul></section>
...
<aside class="tsd-sources">
<p>Inherited from OjTimeAxisBase.isId</p></aside></li></ul></section></section></div>
...
<li><a href="#getScale" class="tsd-is-inherited"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>get<wbr/>Scale</span></a></li>
...
<li><a href="elements.OjTimeAxis.html" class="current"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-128-path"></use><use href="#icon-128-text"></use></svg><span>Oj<wbr/>Time<wbr/>Axis</span></a></li>
