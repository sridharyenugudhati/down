<!DOCTYPE html><html class="default" lang="en"><head><meta charSet="utf-8"/><meta http-equiv="x-ua-compatible" content="IE=edge"/><title>DriverLike | @oracle/oraclejet-webdriver - v15.1.5</title><meta name="description" content="Documentation for @oracle/oraclejet-webdriver"/><meta name="viewport" content="width=device-width, initial-scale=1"/><link rel="stylesheet" href="../assets/style.css"/><link rel="stylesheet" href="../assets/highlight.css"/><script defer src="../assets/main.js"></script><script async src="../assets/search.js" id="tsd-search-script"></script></head><body><script>document.documentElement.dataset.theme = localStorage.getItem("tsd-theme") || "os"</script><header class="tsd-page-toolbar">
...
<li><a href="index.DriverLike.html">DriverLike</a></li></ul>
<h1>Interface DriverLike</h1></div>
<section class="tsd-panel tsd-comment">
<div class="tsd-comment tsd-typography"><p>This interface describes the functions that are needed from the driver object
...
locate the component elemenet.</p>
<a id="md:using-webdriver-instance-to-locate-a-button-in-the-document" class="tsd-anchor"></a><h6><a href="#md:using-webdriver-instance-to-locate-a-button-in-the-document">Using WebDriver instance to locate a button in the document</a></h6><pre><code class="language-javascript"><span class="hl-3">const</span><span class="hl-1"> </span><span class="hl-7">driver</span><span class="hl-1"> = </span><span class="hl-3">new</span><span class="hl-1"> </span><span class="hl-0">Builder</span><span class="hl-1">().</span><span class="hl-0">build</span><span class="hl-1">();</span><br/><span class="hl-3">let</span><span class="hl-1"> </span><span class="hl-5">button</span><span class="hl-1"> = </span><span class="hl-4">await</span><span class="hl-1"> </span><span class="hl-0">ojButton</span><span class="hl-1">(</span><span class="hl-5">driver</span><span class="hl-1">, </span><span class="hl-5">By</span><span class="hl-1">.</span><span class="hl-0">id</span><span class="hl-1">(</span><span class="hl-2">&quot;mybutton&quot;</span><span class="hl-1">))</span>
</code><button>Copy</button></pre>
<a id="md:using-webelement-instance-to-locate-a-button-underneath-a-ltdivgt" class="tsd-anchor"></a><h6><a href="#md:using-webelement-instance-to-locate-a-button-underneath-a-ltdivgt">Using WebElement instance to locate a button underneath a &lt;div&gt;</a></h6><pre><code class="language-javascript"><span class="hl-3">let</span><span class="hl-1"> </span><span class="hl-5">div</span><span class="hl-1"> = </span><span class="hl-4">await</span><span class="hl-1"> </span><span class="hl-5">driver</span><span class="hl-1">.</span><span class="hl-0">findElement</span><span class="hl-1">(</span><span class="hl-5">By</span><span class="hl-1">.</span><span class="hl-0">id</span><span class="hl-1">(</span><span class="hl-2">&quot;my-div&quot;</span><span class="hl-1">));</span><br/><span class="hl-3">let</span><span class="hl-1"> </span><span class="hl-5">button</span><span class="hl-1"> = </span><span class="hl-4">await</span><span class="hl-1"> </span><span class="hl-0">ojButton</span><span class="hl-1">(</span><span class="hl-5">div</span><span class="hl-1">, </span><span class="hl-5">By</span><span class="hl-1">.</span><span class="hl-0">css</span><span class="hl-1">(</span><span class="hl-2">&quot;oj-button&quot;</span><span class="hl-1">));</span>
</code><button>Copy</button></pre>
</div></section>
<section class="tsd-panel tsd-hierarchy">
<h4>Hierarchy</h4>
<ul class="tsd-hierarchy">
<li><span class="target">DriverLike</span></li></ul></section>
...
<div class="tsd-index-list"><a href="index.DriverLike.html#findElement" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><rect fill="var(--color-icon-background)" stroke="#FF4DB8" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="12" id="icon-2048-path"></rect><path d="M9.162 16V7.24H10.578L11.514 10.072C11.602 10.328 11.674 10.584 11.73 10.84C11.794 11.088 11.842 11.28 11.874 11.416C11.906 11.28 11.954 11.088 12.018 10.84C12.082 10.584 12.154 10.324 12.234 10.06L13.122 7.24H14.538V16H13.482V12.82C13.482 12.468 13.49 12.068 13.506 11.62C13.53 11.172 13.558 10.716 13.59 10.252C13.622 9.78 13.654 9.332 13.686 8.908C13.726 8.476 13.762 8.1 13.794 7.78L12.366 12.16H11.334L9.894 7.78C9.934 8.092 9.97 8.456 10.002 8.872C10.042 9.28 10.078 9.716 10.11 10.18C10.142 10.636 10.166 11.092 10.182 11.548C10.206 12.004 10.218 12.428 10.218 12.82V16H9.162Z" fill="var(--color-text)" id="icon-2048-text"></path></svg><span>find<wbr/>Element</span></a>
<a href="index.DriverLike.html#findElements" class="tsd-index-link"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>find<wbr/>Elements</span></a>
</div></section></div></details></section></section>
<section class="tsd-panel-group tsd-member-group">
<h2>Methods</h2>
<section class="tsd-panel tsd-member"><a id="findElement" class="tsd-anchor"></a>
...
<li class="tsd-signature tsd-anchor-link" id="findElement.findElement-1"><span class="tsd-kind-call-signature">find<wbr/>Element</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">by</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">WebElementPromise</span><a href="#findElement.findElement-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Find an element using a given locator strategy</p>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">by</span>: <span class="tsd-signature-type ">Locator</span></h5>
<div class="tsd-comment tsd-typography"><p>The locator strategy to find the element</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">WebElementPromise</span></h4></li></ul></section>
<section class="tsd-panel tsd-member"><a id="findElements" class="tsd-anchor"></a>
...
<ul class="tsd-signatures">
<li class="tsd-signature tsd-anchor-link" id="findElements.findElements-1"><span class="tsd-kind-call-signature">find<wbr/>Elements</span><span class="tsd-signature-symbol">(</span><span class="tsd-kind-parameter">by</span><span class="tsd-signature-symbol">)</span><span class="tsd-signature-symbol">: </span><span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">WebElement</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span><a href="#findElements.findElements-1" aria-label="Permalink" class="tsd-anchor-icon"><svg class="icon icon-tabler icon-tabler-link" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><use href="#icon-anchor-a"></use><use href="#icon-anchor-b"></use><use href="#icon-anchor-c"></use></svg></a></li>
<li class="tsd-description">
<div class="tsd-comment tsd-typography"><p>Find a set of elements using a given locator strategy</p>
</div>
<div class="tsd-parameters">
<h4 class="tsd-parameters-title">Parameters</h4>
<ul class="tsd-parameter-list">
<li>
<h5><span class="tsd-kind-parameter">by</span>: <span class="tsd-signature-type ">Locator</span></h5>
<div class="tsd-comment tsd-typography"><p>The locator strategy to find the elements</p>
</div></li></ul></div>
<h4 class="tsd-returns-title">Returns <span class="tsd-signature-type ">Promise</span><span class="tsd-signature-symbol">&lt;</span><span class="tsd-signature-type ">WebElement</span><span class="tsd-signature-symbol">[]</span><span class="tsd-signature-symbol">&gt;</span></h4></li></ul></section></section></div>
...
<li>
<ul>
<li><a href="#md:using-webdriver-instance-to-locate-a-button-in-the-document"><span>Using <wbr/>Web<wbr/>Driver instance to locate a button in the document</span></a></li>
<li>
<ul>
<li><a href="#md:using-webelement-instance-to-locate-a-button-underneath-a-ltdivgt"><span>Using <wbr/>Web<wbr/>Element instance to locate a button underneath a &lt;div&gt;</span></a></li></ul></li></ul></li>
<li><a href="#findElement" class=""><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>find<wbr/>Element</span></a></li>
<li><a href="#findElements" class=""><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-2048-path"></use><use href="#icon-2048-text"></use></svg><span>find<wbr/>Elements</span></a></li></ul></div></details></div>
<div class="site-menu">
...
<li><a href="index.DriverLike.html" class="current"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><rect fill="var(--color-icon-background)" stroke="var(--color-ts-interface)" stroke-width="1.5" x="1" y="1" width="22" height="22" rx="6" id="icon-256-path"></rect><path d="M9.51 16V15.016H11.298V8.224H9.51V7.24H14.19V8.224H12.402V15.016H14.19V16H9.51Z" fill="var(--color-text)" id="icon-256-text"></path></svg><span>Driver<wbr/>Like</span></a></li>
<li><a href="index.SlotProxy.html"><svg class="tsd-kind-icon" width="24" height="24" viewBox="0 0 24 24"><use href="#icon-256-path"></use><use href="#icon-256-text"></use></svg><span>Slot<wbr/>Proxy</span></a></li>
