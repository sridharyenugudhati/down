...
<h2>@oracle/oraclejet-webdriver - v15.1.5</h2></div>
<div class="tsd-panel tsd-typography"><a id="md:oracle-jet-component-webelements" class="tsd-anchor"></a><h1><a href="#md:oracle-jet-component-webelements">Oracle JET Component WebElements</a></h1><p>oraclejet-webdriver is a UI automation library built on top of
<a href="https://www.selenium.dev/selenium/docs/api/javascript/">selenium-webdriver</a>, and
designed to work with <a href="https://www.npmjs.com/package/@oracle/oraclejet">Oracle JET</a>-based applications.</p>
<a id="md:installation" class="tsd-anchor"></a><h2><a href="#md:installation">Installation</a></h2><pre><code class="language-bash"><span class="hl-0">npm</span><span class="hl-1"> </span><span class="hl-2">install</span><span class="hl-1"> </span><span class="hl-3">-D</span><span class="hl-1"> </span><span class="hl-2">@oracle/oraclejet-webdriver</span>
</code><button>Copy</button></pre>
<a id="md:usage" class="tsd-anchor"></a><h2><a href="#md:usage">Usage</a></h2><p>The library is available with type definitions so that tests can be authored in
<a href="https://www.npmjs.com/package/typescript">TypeScript</a>.</p>
<p>The root module <code>@oracle/oraclejet-webdriver</code> has a
<a href="modules/index.html#default">default export</a> where common utilities can be found.
WebElements that correspond to JET components can be found underneath
<code>@oracle/oraclejet-webdriver/elements</code></p>
<p>A sample test script using <a href="https://mochajs.org">Mocha</a>:</p>
<pre><code class="language-javascript"><span class="hl-4">import</span><span class="hl-1"> </span><span class="hl-5">ojwd</span><span class="hl-1">, { </span><span class="hl-5">DriverManager</span><span class="hl-1"> } </span><span class="hl-4">from</span><span class="hl-1"> </span><span class="hl-2">&#39;@oracle/oraclejet-webdriver&#39;</span><span class="hl-1">;</span><br/><span class="hl-4">import</span><span class="hl-1"> { </span><span class="hl-5">ojInputText</span><span class="hl-1"> } </span><span class="hl-4">from</span><span class="hl-1"> </span><span class="hl-2">&#39;@oracle/oraclejet-webdriver/elements&#39;</span><span class="hl-1">;</span><br/><span class="hl-4">import</span><span class="hl-1"> { </span><span class="hl-5">By</span><span class="hl-1">, </span><span class="hl-5">WebDriver</span><span class="hl-1"> } </span><span class="hl-4">from</span><span class="hl-1"> </span><span class="hl-2">&#39;selenium-webdriver&#39;</span><span class="hl-1">;</span><br/><br/><span class="hl-0">describe</span><span class="hl-1">(</span><span class="hl-2">&#39;My suite of tests&#39;</span><span class="hl-1">, </span><span class="hl-3">function</span><span class="hl-1"> () {</span><br/><span class="hl-1">  </span><span class="hl-3">let</span><span class="hl-1"> </span><span class="hl-5">driver</span><span class="hl-1">: </span><span class="hl-6">WebDriver</span><span class="hl-1">;</span><br/><br/><span class="hl-1">  </span><span class="hl-0">before</span><span class="hl-1">(</span><span class="hl-3">async</span><span class="hl-1"> </span><span class="hl-3">function</span><span class="hl-1"> () {</span><br/><span class="hl-1">    </span><span class="hl-5">driver</span><span class="hl-1"> = </span><span class="hl-4">await</span><span class="hl-1"> </span><span class="hl-5">DriverManager</span><span class="hl-1">.</span><span class="hl-0">getDriver</span><span class="hl-1">();</span><br/><span class="hl-1">    </span><span class="hl-4">await</span><span class="hl-1"> </span><span class="hl-5">ojwd</span><span class="hl-1">.</span><span class="hl-0">get</span><span class="hl-1">(</span><span class="hl-5">driver</span><span class="hl-1">, </span><span class="hl-2">&#39;http://myapp.com/&#39;</span><span class="hl-1">);</span><br/><span class="hl-1">  });</span><br/><br/><span class="hl-1">  </span><span class="hl-0">it</span><span class="hl-1">(</span><span class="hl-2">&#39;changes an &amp;lt;oj-input-text&gt; value&#39;</span><span class="hl-1">, </span><span class="hl-3">async</span><span class="hl-1"> </span><span class="hl-3">function</span><span class="hl-1"> () {</span><br/><span class="hl-1">    </span><span class="hl-3">const</span><span class="hl-1"> </span><span class="hl-7">input</span><span class="hl-1"> = </span><span class="hl-4">await</span><span class="hl-1"> </span><span class="hl-0">ojInputText</span><span class="hl-1">(</span><span class="hl-5">driver</span><span class="hl-1">, </span><span class="hl-5">By</span><span class="hl-1">.</span><span class="hl-0">id</span><span class="hl-1">(</span><span class="hl-2">&#39;text-input-1&#39;</span><span class="hl-1">));</span><br/><span class="hl-1">    </span><span class="hl-4">await</span><span class="hl-1"> </span><span class="hl-5">input</span><span class="hl-1">.</span><span class="hl-0">changeValue</span><span class="hl-1">(</span><span class="hl-2">&#39;...&#39;</span><span class="hl-1">);</span><br/><span class="hl-1">  });</span><br/><br/><span class="hl-1">  </span><span class="hl-0">after</span><span class="hl-1">(</span><span class="hl-3">function</span><span class="hl-1"> () {</span><br/><span class="hl-1">    </span><span class="hl-5">DriverManager</span><span class="hl-1">.</span><span class="hl-0">releaseDriver</span><span class="hl-1">(</span><span class="hl-5">driver</span><span class="hl-1">);</span><br/><span class="hl-1">  });</span><br/><span class="hl-1">});</span>
</code><button>Copy</button></pre>
<a id="md:compatibility" class="tsd-anchor"></a><h2><a href="#md:compatibility">Compatibility</a></h2><p>It&#39;s important to use the same version of oraclejet-webdriver which matches your
oraclejet. If the versions differ, the library will throw an exception upon opening
the page and a console error will be logged.</p>
<a id="md:dependencies" class="tsd-anchor"></a><h3><a href="#md:dependencies">Dependencies</a></h3><p>This library depends on the following:</p>
<ul>
<li><a href="https://www.npmjs.com/package/@oracle/oraclejet">@oracle/oraclejet</a></li>
<li><a href="https://www.npmjs.com/package/selenium-webdriver">selenium-webdriver &gt;= 4.0.0</a></li>
<li>NodeJS v12+</li>
</ul>
</div></div>
...
<li>
<ul>
<li><a href="#md:oracle-jet-component-webelements"><span>Oracle JET <wbr/>Component <wbr/>Web<wbr/>Elements</span></a></li>
<li>
<ul>
...
<li>
<ul>
<li><a href="#md:dependencies"><span>Dependencies</span></a></li></ul></li></ul></li></ul></li></ul></div></details></div>
<div class="site-menu">
